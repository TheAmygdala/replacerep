...
<html lang="de">
  <head>
    ...
    <title>Richtlinien zur Internetnutzung :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../04-lektion-internet/08.internet-richtlinien.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../04-lektion-internet/09.zusammenfassung.php" title="Zusammenfassung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../04-lektion-internet/07.blocken-unerwuenschter-seiten.php" title="Blocken unerwünschter Seiten (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Richtlinien zur Internetnutzung</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-globe-africa"></i></div></div></div>


<p>Viele Behörden und Einrichtungen legen konkrete Richtlinien für die Internetnutzung fest. Diese regeln z.B.</p>
<ul>
<li>die private Nutzung von Internet-Diensten,</li>
<li>den Umgang mit schützenswerten und vertraulichen Daten,</li>
<li>die Verantwortung der Beschäftigten für Datenschutz und Datensicherheit,</li>
<li>Verbote der Installation von Software,</li>
<li>Verbote von Einrichtung und Betrieb nicht-genehmigter Internet-Zugänge,</li>
<li>die Protokollierung von E-Mail- und Internet-Nutzung.</li>
</ul>
...
<ul>
<li>Zur Aufrechterhaltung des Betriebs oder zur Fehleranalyse muss der Internetverkehr in bestimmten Situationen protokolliert werden (grundsätzlich nicht die Inhalte, sondern die Umstände der Kommunikation).</li>
<li>Bedenken Sie beim Surfen, dass Ihr Verhalten im Internet möglicherweise überwacht wird!</li>
<li>Genauere Informationen erhalten Sie auch bei Ihrer <a href="../ansprechpersonen.php">Ansprechperson</a></li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/04-lektion-internet/08.internet-richtlinien.php" class="dd-item active"><a href="../04-lektion-internet/08.internet-richtlinien.php">Richtlinien zur Internetnutzung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/04-lektion-internet/08.internet-richtlinien.php" selected>Deutsch</option>
                  </select>
                </div>
