...
<html lang="de">
  <head>
    ...
    <title>Blocken unerwünschter Seiten :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../04-lektion-internet/07.blocken-unerwuenschter-seiten.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../04-lektion-internet/08.internet-richtlinien.php" title="Richtlinien zur Internetnutzung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../04-lektion-internet/06.verschluesselter-zugriff-auf-webseiten.php" title="Verschlüsselter Zugriff auf Webseiten (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Blocken unerwünschter Seiten</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-globe-africa"></i></div></div></div>


<p>Einige Behörden und Einrichtungen stellen mit Hilfe von zentralen Filtersystemen sicher, dass Webseiten mit extremistischen, pornografischen und vergleichbaren Inhalten automatisch geblockt werden. Davon unabhängig sollten Sie von sich aus Internetangebote meiden,</p>
<ul>
<li>die strafbare bzw. rechtswidrige Inhalte haben,</li>
<li>die andere Personen am Arbeitsplatz belästigen oder - insbesondere minderjährige Kolleginnen und Kollegen - verstören können,</li>
<li>die keinen dienstlichen Bezug haben, insbesondere wenn Ihnen die private Internetnutzung untersagt ist.</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/04-lektion-internet/07.blocken-unerwuenschter-seiten.php" class="dd-item active"><a href="../04-lektion-internet/07.blocken-unerwuenschter-seiten.php">Blocken unerwünschter Seiten<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/04-lektion-internet/07.blocken-unerwuenschter-seiten.php" selected>Deutsch</option>
                  </select>
                </div>
