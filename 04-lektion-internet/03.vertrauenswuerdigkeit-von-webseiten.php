...
<html lang="de">
  <head>
    ...
    <title>Vertrauenswürdigkeit von Webseiten :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../04-lektion-internet/03.vertrauenswuerdigkeit-von-webseiten.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../04-lektion-internet/04.technische-webinhalte.php" title="Technische Webinhalte (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../04-lektion-internet/02.gefahren-im-internet.php" title="Gefahren im Internet (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Vertrauenswürdigkeit von Webseiten</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-globe-africa"></i></div></div></div>


<p>Haben Sie sich schon mal Gedanken darüber gemacht, wer eine Web-Seite veröffentlicht und wer für den Inhalt verantwortlich ist?</p>
<p>Diese Fragen sind mit letzter Sicherheit oft nur schwer zu beantworten. Viele Informationen erscheinen im Internet anonym und ungeprüft. Die technisch leicht mögliche automatische Weiterleitung auf andere Web-Server macht es Ihnen zudem schwer, die Kontrolle zu behalten.</p>
<p>Stetig werden neue Technologien entwickelt, um Inhalte attraktiver, schneller und dynamischer zu präsentieren.</p>
<p>Dabei werden auch Methoden entwickelt, um Ihr Surf-Verhalten zu analysieren. Unsichtbar laufen Programme ab, die Ihr Arbeiten im Internet beobachten, beeinflussen oder Sie sogar in die Irre führen sollen.</p>
...
<ul>
<li>Recherchieren Sie nur in vertrauenswürdigen Quellen.</li>
<li>Bleiben Sie kritisch gegenüber Informationen, die Sie im Internet finden.</li>
<li>Fragen Sie sich immer, wer für den Inhalt verantwortlich ist und ob Sie dieser Person vertrauen können.</li>
<li>Surfen Sie bewusst und bedenken Sie jeden „Klick“.</li>
<li>Speichern Sie Informationen möglichst nur aus vertrauenswürdigen Quellen.</li>
<li>Laden Sie auf Ihren dienstlichen Computer keine Programme aus dem Internet herunter.</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/04-lektion-internet/03.vertrauenswuerdigkeit-von-webseiten.php" class="dd-item active"><a href="../04-lektion-internet/03.vertrauenswuerdigkeit-von-webseiten.php">Vertrauenswürdigkeit von Webseiten<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/04-lektion-internet/03.vertrauenswuerdigkeit-von-webseiten.php" selected>Deutsch</option>
                  </select>
                </div>
