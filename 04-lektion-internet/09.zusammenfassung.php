...
<html lang="de">
  ...
  <body class="mobile-support default" data-url="../04-lektion-internet/09.zusammenfassung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../04-lektion-internet/90.quiz-internet.php" title="Quiz - Internet (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../04-lektion-internet/08.internet-richtlinien.php" title="Richtlinien zur Internetnutzung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<p>Die Nutzung des Internets ist weiterhin gefährlich. Zwar schützen und Virenscanner und andere technische Maßnahmen vor Angriffe aus dem Web. Aber wir alle müssen immer aufmerksam beim Aufrufen von Web-Seiten sein.</p>
<ul>
<li>Recherchieren Sie nur in vertrauenswürdigen Quellen.</li>
<li>Bleiben Sie kritisch gegenüber allen Informationen, die Sie im Internet finden.</li>
...
<li>Laden Sie keine Programme auf Ihren dienstlichen Computer aus dem Internet herunter.</li>
<li>Überprüfen Sie im Zweifelsfall über das Schloss-Symbol in der Adresszeile Ihres Browsers das Zertifikat der Web-Seite.</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/04-lektion-internet/09.zusammenfassung.php" class="dd-item active"><a href="../04-lektion-internet/09.zusammenfassung.php">Zusammenfassung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/04-lektion-internet/09.zusammenfassung.php" selected>Deutsch</option>
                  </select>
                </div>
