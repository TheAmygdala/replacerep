...
<html lang="de">
  <head>
    ...
    <title>Schutz vor technischen Webinhalten :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../04-lektion-internet/05.schutz-vor-technischen-webinhalten.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../04-lektion-internet/06.verschluesselter-zugriff-auf-webseiten.php" title="Verschlüsselter Zugriff auf Webseiten (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../04-lektion-internet/04.technische-webinhalte.php" title="Technische Webinhalte (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Schutz vor technischen Webinhalten</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-globe-africa"></i></div></div></div>


<ul>
<li>In den meisten Behörden und Einrichtungen ist eine sichere Konfiguration des Browsers fest vorgegeben! Versuchen Sie nicht, diese zu ändern.</li>
<li>Laden und starten Sie keine Programme von Webseiten, sofern Sie nicht dienstlich dazu angehalten werden.</li>
</ul>
<p>Damit Zugangsdaten und Seiteninhalte bei der Übertragung im offenen Internet nicht von Dritten mitgelesen werden können, wird für die Übertragung das technische Protokoll „TLS“ (Transport Layer Security) verwendet. Entsprechende Angebote erkennen Sie u.a. an der der Adresse vorangestellten Abkürzung „https“.</p>
<p>Zu allen Seiten, deren Adresse mit <strong>https://</strong> beginnt, baut der Browser automatisch eine verschlüsselte Verbindung auf. So wird sichergestellt, dass bei der Übermittlung grundsätzlich keine Daten mitgelesen oder verändert werden können. Hierfür muss das Zertifikat der Internetseite (siehe unten stehender Tipp) der herausgebenden Stelle der Seite zugeordnet sein.</p>

<div class="box notices cstyle tip">
    <div class="box-label"><i class="fa-fw fas fa-lightbulb"></i> Gut zu wissen</div>
    <div class="box-content">
<p>Ein Zertifikat ist eine „elektronische Bescheinigung“, mit der die Zuordnung  einer Internetseite zu ihrer herausgebenden Stelle dokumentiert wird. Damit verbunden ist die Absicherung der Seitenaufrufe über eine Transportverschlüsselung (über HTTPS, siehe die Erläuterungen zum <a href="../04-lektion-internet/01.was-ist-das-internet.php">Technischen Aufbau des Internets</a>).
Das Zertifikat einer Internetseite können Sie aufrufen, in dem Sie in der Adresszeile Ihres Browsers auf das Schloss-Symbol klicken.</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/04-lektion-internet/05.schutz-vor-technischen-webinhalten.php" class="dd-item active"><a href="../04-lektion-internet/05.schutz-vor-technischen-webinhalten.php">Schutz vor technischen Webinhalten<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/04-lektion-internet/05.schutz-vor-technischen-webinhalten.php" selected>Deutsch</option>
                  </select>
                </div>
