...
<html lang="de">
  <head>
    ...
    <title>Gefahren im Internet :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../04-lektion-internet/02.gefahren-im-internet.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../04-lektion-internet/03.vertrauenswuerdigkeit-von-webseiten.php" title="Vertrauenswürdigkeit von Webseiten (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../04-lektion-internet/01.was-ist-das-internet.php" title="Was ist das Internet? (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Gefahren im Internet</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-globe-africa"></i></div></div></div>


<p>So schnell und einfach wie Sie im Internet auf Daten zugreifen können, so leicht können Sie sich auch in Gefahr begeben:</p>
<ul>
<li>So können beim Surfen Schadprogramme auf Ihrem Computer unbemerkt ausgeführt werden. Auf diese Weise können Viren eingeschleust und Daten Ihres Rechners ausspioniert oder verändert werden.</li>
<li>Sogar harmlos aussehende Bilder können schädliche Befehle enthalten.</li>
</ul>
<p>Zwar werden Web-Zugriffe schon am Netzknoten Ihrer Einrichtung auf Viren und schädliche Programme untersucht. Dennoch ist beim Surfen Vorsicht geboten: Sie können nie sicher sein, welche Inhalte oder Befehle auf Ihrem Computer ausgeführt werden, wenn eine Web-Seite von Ihrem Browser aufgerufen wird.</p>
<p>Die nächsten Seiten zeigen Ihnen, worauf Sie beim Surfen achten sollten und wie Sie sich gegen Angriffe schützen können.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>In Ihrer Behörde oder Einrichtung werden die Sicherheitseinstellungen Ihres Browsers meist vorgegeben</li>
<li>Ändern Sie diese dann nicht ab!</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/04-lektion-internet/02.gefahren-im-internet.php" class="dd-item active"><a href="../04-lektion-internet/02.gefahren-im-internet.php">Gefahren im Internet<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/04-lektion-internet/02.gefahren-im-internet.php" selected>Deutsch</option>
                  </select>
                </div>
