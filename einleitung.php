...
<html lang="de">
  <head>
    ...
    <title>Einleitung :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./einleitung/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./einleitung.php">
...
<h2 id="informationen-sind-wertvoll">Informationen sind wertvoll</h2>
<h3 id="ziele-von-hahahugoshortcode-s0-hbhb">Ziele von BITS</h3>
<p>Informationen sind wertvoll. Sie werden immer bedeutender für Behörden und Einrichtungen, aber auch Privatpersonen. Heute werden Informationen größtenteils digital gespeichert und verarbeitet. Daher rückt das Thema IT-Sicherheit mehr und mehr in den Blickpunkt. Im Zentrum stehen die <strong>Schutzziele der Informationssicherheit</strong>.</p>
<p>Gelangen Informationen Ihrer Einrichtung oder über Sie an Unbefugte, hat das nicht selten schwerwiegende Folgen. Sollten z.B. Ausschreibungsunterlagen vorzeitig Anbieterunternehmen vorliegen, könnten diese rechtswidrige Absprachen treffen und so den Staat und damit die Gesellschaft schädigen. Die <strong>Vertraulichkeit</strong> von Informationen ist daher zu schützen.</p>
<p>Auch ist es wichtig, dass Daten richtig und unverändert (integer) sind. Unbemerkt verfälschte Daten, etwa manipulierte Adressen, können zu falschen Entscheidungen führen - daher ist die <strong>Integrität</strong> von Informationen ein weiteres Schutzziel.</p>
<p>Und schließlich ist die <strong>Verfügbarkeit</strong> von Informationen zu gewährleisten - sie müssen dann verfügbar sein, wenn sie gebraucht werden. Schon ein mehrstündiger Ausfall des E-Mail-Systems kann eine ganze Behörde oder Einrichtung für einen ganzen Tag lahmlegen.</p>
<p>Bitte unterschätzen Sie dabei nicht, welche Bedeutung Informationen über Ihre Person für Angreifende haben können! Oft sucht man sich ein vermeintlich schwaches Glied in der Kette, um diese darüber zu brechen.</p>
<p>Das Behörden-IT-Sicherheitstraining BITS erläutert allgemein anerkannte Sicherheitsrichtlinien und vermittelt konkrete Verhaltenshinweise zum praktischen Umgang mit Informationen. Bitte beachten Sie, dass Dienstanweisungen oder -vereinbarungen Ihrer Behörde oder Einrichtung stets Vorrang haben. Im Zweifel wenden Sie sich bitte an die zuständige <a href="./ansprechpersonen.php">Ansprechperson</a>.</p>
<p>Nach diesem Training werden Sie wissen, wie Sie sich richtig am Computer, am Smartphone und im Internet verhalten. Nutzen Sie Ihr Wissen auch für den privaten Bereich, es drohen überall die gleichen Gefahren!</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p>In orangefarbenen Kästen stehen wichtige Verhaltensregeln.</p>
    </div>
</div>
...
<div class="box notices cstyle tip">
    ...
    <div class="box-content">
<p>In grünen Kästen stehen nützliche Hinweise.</p>
    </div>
</div>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/einleitung.php" selected>Deutsch</option>
                  </select>
                </div>
