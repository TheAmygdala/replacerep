...
<html lang="de">
  <head>
    ...
    <title>Cloud :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./07-lektion-cloud/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./07-lektion-cloud.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./07-lektion-cloud/01.einleitung.php" title="Cloud-Dienste (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./06-lektion-social-media/90.quiz-social-media.php" title="Quiz - Social Media (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<div class="article-subheading">Lektion 7</div>
<h1>Cloud</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-list"><i class="fas fa-cloud"></i></div></div></div>


<h2 id="fremde-rechner-für-sich-nutzen">Fremde Rechner für sich nutzen</h2>
<p>In dieser Lektion lernen Sie,</p>
<ul>
<li>was man unter Cloud-Diensten versteht,</li>
<li>welche Cloud-Dienste es gibt,</li>
<li>wie sich öffentliche und private Cloud-Dienste unterscheiden und</li>
<li>wie Sie Cloud-Dienste sicher nutzen können.</li>
</ul>
  ...
  <img src="./images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/07-lektion-cloud.php" class="dd-item active parent"><a href="./07-lektion-cloud.php">7. Lektion Cloud<i class="fas fa-check read-icon"></i></a><ul id="subsections-34918d1cd94a60ac0b2441e8b9ec5827">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/07-lektion-cloud.php" selected>Deutsch</option>
                  </select>
                </div>
