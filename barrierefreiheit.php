...
<html lang="de">
  <head>
    ...
    <title>Barrierefreiheit :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="./barrierefreiheit.php">
...
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-universal-access"></i></div></div></div>


<h2 id="tastaturnavigation">Tastaturnavigation</h2>
<p>BITS unterstützt die Navigation auch über die Tastatur. Aufzuklappende weiterführende Erläuterungen erfordern aktuell noch eine Mausbedienung.</p>
<h3 id="seitennavigation">Seitennavigation</h3>
<p>Um zur nächsten Seite zu gelangen, ist die Taste Pfeiltaste nach rechts zu verwenden, um zur vorangehenden Seite zu kommen die Pfeiltaste nach links.</p>
<h3 id="quiz">Quiz</h3>
<h4 id="chrome-basierte-browser-chrome-ms-edge-vivaldi-etc">Chrome-basierte Browser (Chrome, MS Edge, Vivaldi etc.)</h4>
<p>Aufgrund eines Bugs in der Version 6.2.x von BITS muss in Chrome-basierten Browsern auf der ersten Seite jedes Quiz&rsquo; der Mauszeiger kurz bewegt werden, um die Navigation im Quiz-Block über die Tastatur zu ermöglichen. Dieser wird über die Tabulator-Taste erreicht. Mit den Pfeiltasten (nach oben oder unten) kann dann eine Antwort ausgewählt werden. Anschließend ist über die Tabulator-Taste und die Return-Taste die nächste Aktion auszuwählen bzw. auszulösen. Auf der nächsten Seite muss bei bei gedrückter Umschalt-Taste über die Tabulator-Taste der Antwort-Block angesteuert werden, um über die Pfeiltasten die nächste Antwort zu markieren; im Übrigen geht es weiter wie auf der ersten Seite des Quiz'.</p>
<h4 id="firefox">Firefox</h4>
<p>Im Browser Firefox ist der Quiz-Block über die Tabulator-Taste anzusteuern. Mit dieser ist auch eine Antwort auszuwählen und über die Leer-Taste zu aktivieren; nach oben kann im Quiz-Block über die gedrückte Umschalt-Taste und die Tabulator-Taste navigiert werden. Anschließend ist erneut über die Tabulator-Taste die nächste Aktion auszuwählen und über die Return-Taste zu bestätigen. Auf der nächsten Seite muss bei bei gedrückter Umschalt-Taste über die Tabulator-Taste der Antwort-Block angesteuert werden; im Übrigen geht es weiter wie auf der ersten Seite des Quiz'.</p>
<h4 id="safari">Safari</h4>
<p>Der Safari-Browser bietet aktuell leider keine Möglichkeit, das Quiz per Tastatur zu nutzen.</p>
<h2 id="kontrast">Kontrast</h2>
<p>Die Kontrast-Darstellung wurde weitestgehend barrierefrei gestaltet. Im linken Menü kann unten beim Pinsel-Symbol eine besonders deutliche Kontrast-Darstellung ausgewählt werden.</p>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/barrierefreiheit.php" selected>Deutsch</option>
                  </select>
                </div>
