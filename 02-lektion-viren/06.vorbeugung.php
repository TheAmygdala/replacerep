...
<html lang="de">
  <head>
    ...
    <title>Vorbeugung :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../02-lektion-viren/06.vorbeugung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../02-lektion-viren/07.virenbefall-was-tun.php" title="Virenbefall - was tun? (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../02-lektion-viren/05.risiken-und-schaeden.php" title="Risiken und Schäden (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h3 id="wie-in-der-medizin-gilt-vorbeugen-ist-besser-als-heilen">Wie in der Medizin gilt: „Vorbeugen ist besser als Heilen“</h3>
<p>Um Dateien und Systeme vor Viren zu schützen und gegebenenfalls von diesen zu säubern, gibt es speziell dafür Computer-Programme, sogenannte Virenscanner.</p>
<p>In den meisten Behörden und Einrichtungen werden alle Server und PCs mit einem Virenscanner ausgestattet, der eingehende E-Mails untersucht. Er darf nie ausgeschaltet werden.</p>
<p>Auch jeder Privat-PC sollte immer durch einen aktuellen Virenscanner geschützt sein.</p>
<p>Der Virenscanner muss so außerdem eingestellt sein, dass alle Daten beim Öffnen auf Viren überprüft werden („On Access“).</p>
<p>Der Virenscanner muss schließlich so eingestellt sein, dass er sich mindestens täglich selbständig aktualisiert. Sollte wider Erwarten eine Meldung erscheinen, dass der Scanner veraltet ist, informieren Sie bitte direkt Ihre <a href="../ansprechpersonen.php">Ansprechperson</a>. Zusätzlich sollte der Virenscanner so eingestellt werden, dass er einmal pro Woche das gesamte System auf Viren überprüft („On Demand“).</p>
<p>Auch ein aktueller Virenscanner bietet keinen 100%igen Schutz. Deshalb sollten Sie, wenn möglich, Ihre Daten auf Netzlaufwerken speichern. Sie werden in den meisten Behörden und Einrichtungen von dort regelmäßig gesichert und können nach einem Schaden wieder hergestellt werden.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/02-lektion-viren/06.vorbeugung.php" class="dd-item active"><a href="../02-lektion-viren/06.vorbeugung.php">Vorbeugung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren/06.vorbeugung.php" selected>Deutsch</option>
                  </select>
                </div>
