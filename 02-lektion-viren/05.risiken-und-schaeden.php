...
<html lang="de">
  <head>
    ...
    <title>Risiken und Schäden :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../02-lektion-viren/05.risiken-und-schaeden.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../02-lektion-viren/06.vorbeugung.php" title="Vorbeugung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../02-lektion-viren/04.infektionswege.php" title="Infektionswege (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Risiken und Schäden</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-shield-virus"></i></div></div></div>


<h4 id="gefahren-steigen-mit-dem-anschluss-ans-internet">Gefahren steigen mit dem Anschluss ans Internet</h4>
<p>Bei jedem Computer, der Zugang zum Internet hat, besteht die Gefahr eines Virenbefalls. Mit der steigenden Nutzung von Rechnern als Kommunikationsmedium steigt auch die Virengefahr. Sobald ein Internetanschluss vorliegt, liegt die Wahrscheinlichkeit eines Virenangriffs bei 100%.</p>
<p>Der drohende Schaden kann beträchtlich sein:</p>
<ul>
<li>Werden durch einen Virenbefall Daten zerstört, so entstehen Ihrer Behörde oder Einrichtung gegebenenfalls hohe Aufwände bei der Wiederherstellung.</li>
<li>Gelangen ausspionierte Daten an die Öffentlichkeit, so können Ihrer Behörde oder Einrichtung Ansehens- und Vertrauensschäden entstehen, von Datenschutzverstößen ganz zu schweigen.</li>
<li>Selbst wenn keine Informationen gelöscht oder ausspioniert werden, kann das Wiederherstellen befallener Systeme zeitaufwändig sein und hohe Kosten verursachen.</li>
</ul>
...
<ul>
<li>Ohne einen aktuellen Virenscanner auf Laptop oder PC ist ist eine Virus-Infektion vorprogrammiert.</li>
<li>Virenscanner sind unverzichtbar</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/02-lektion-viren/05.risiken-und-schaeden.php" class="dd-item active"><a href="../02-lektion-viren/05.risiken-und-schaeden.php">Risiken und Schäden<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren/05.risiken-und-schaeden.php" selected>Deutsch</option>
                  </select>
                </div>
