...
<html lang="de">
  <head>
    ...
    <title>Infektionswege :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../02-lektion-viren/04.infektionswege.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../02-lektion-viren/05.risiken-und-schaeden.php" title="Risiken und Schäden (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../02-lektion-viren/03.moegliche-schaeden-durch-virenbefall.php" title="Mögliche Schäden durch Virenbefall (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Infektionswege</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-shield-virus"></i></div></div></div>


<p>Viren erreichen auf verschiedenen Wegen ihr Ziel:</p>
<ul>
<li>Der Hauptinfektionsweg ist die E-Mail. Unter Umständen kann schon durch das bloße Lesen einer E-Mail ein Virus aktiv werden (etwa wenn die Auto-Vorschau aktiv ist). Besonders gefährlich ist es, mitgeschickte Dateien (Anhänge) unbedacht zu öffnen.</li>
<li>Auch durch das Öffnen von Dateien, die Sie aus dem Internet herunterladen, kann ein Virus aktiv werden. Manchmal reicht sogar das Besuchen einer infizierten Web-Seite.</li>
<li>Auch das interne Netz kann Ausgangspunkt von Viren sein. Sie können in abgespeicherten Dokumenten oder Programmteilen vorliegen und sich über verbundene Netzlaufwerke automatisch verbreiten oder selbst versenden.</li>
<li>Externe Speichermedien wie USB-Sticks können Viren enthalten - selbst Originale vom Hersteller oder auch der USB-Stick aus der hilfsbereiten Kollegenschaft sind möglicherweise infiziert. Auch Smartphones und Digitalkameras, die mit Ihrem Netz verbunden werden, können Viren übertragen.</li>
<li>Ein nicht zu unterschätzendes Risiko besteht beim Datenaustausch per Smartphone, USB-Stick oder transportabler Festplatte zwischen heimischem PC und Computer im Büro.</li>
</ul>
<p>Manche Behörden und Einrichtungen verschließen USB-Buchsen am Computer mechanisch oder per Software. Respektieren Sie dies!</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Öffnen Sie Anhänge in E-Mails nur, wenn Sie die Absender*in kennen</li>
<li>USB-Buchsen und Netzwerkanschlüsse sind Einfallstore für Viren - respektieren Sie verplombte Schnittstellen!</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/02-lektion-viren/04.infektionswege.php" class="dd-item active"><a href="../02-lektion-viren/04.infektionswege.php">Infektionswege<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren/04.infektionswege.php" selected>Deutsch</option>
                  </select>
                </div>
