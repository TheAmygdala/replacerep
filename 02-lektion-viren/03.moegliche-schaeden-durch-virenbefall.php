...
<html lang="de">
  <head>
    ...
    <title>Mögliche Schäden durch Virenbefall :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../02-lektion-viren/03.moegliche-schaeden-durch-virenbefall.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../02-lektion-viren/04.infektionswege.php" title="Infektionswege (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../02-lektion-viren/02.typen-von-viren.php" title="Typen von Viren (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Mögliche Schäden durch Virenbefall</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-shield-virus"></i></div></div></div>


<p>Je nach Virus sehen die verursachten Schäden sehr unterschiedlich aus.</p>
<p><strong>Früher</strong> war das Hauptangriffsziel die Störung der Systemfunktionen, z.B. durch:</p>
<ul>
<li>Verbrauch von Systemressourcen wie Plattenplatz oder Leitungskapazitäten</li>
<li>Verringerung der Systemleistung</li>
<li>Verändern oder Löschen von Systemdateien</li>
</ul>
<p><strong>Heute</strong> sind die Ziele:</p>
<ul>
<li>Versand von Spam-Nachrichten über Ihren Rechner</li>
<li>Verschlüsselung und anschließende Erpressung („Ransom-Ware“)</li>
<li>Heimliches Ausnutzung der Rechenleistung („Crypto-Jacking“)</li>
<li>Einbindung Ihres Rechners in ein Netzwerk für Angriffe auf Dritte (z.B. für „Denial of Service-Angriffe“)</li>
</ul>
<p>Besonders gefährlich werden Viren, wenn sie sich unbemerkt einschleichen und z.B. wochen- oder monatelang unbemerkt das System und interne Netz nach Informationen ausspionieren. Davon können alle Arbeitsplätze, ob mit oder ohne Führungsverantwortung, als Einfallstor betroffen sein!</p>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/02-lektion-viren/03.moegliche-schaeden-durch-virenbefall.php" class="dd-item active"><a href="../02-lektion-viren/03.moegliche-schaeden-durch-virenbefall.php">Mögliche Schäden durch Virenbefall<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren/03.moegliche-schaeden-durch-virenbefall.php" selected>Deutsch</option>
                  </select>
                </div>
