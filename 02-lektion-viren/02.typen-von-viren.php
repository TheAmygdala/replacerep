...
<html lang="de">
  <head>
    ...
    <title>Typen von Viren :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../02-lektion-viren/02.typen-von-viren.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../02-lektion-viren/03.moegliche-schaeden-durch-virenbefall.php" title="Mögliche Schäden durch Virenbefall (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../02-lektion-viren/01.was-sind-computerviren.php" title="Was sind Computerviren? (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Typen von Viren</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-shield-virus"></i></div></div></div>


<p>Häufig wird der englische Oberbegriff „Malware“ („mal“ =  „schädigend“) für alle Arten von Computerviren verwendet. Man unterscheidet unterschiedliche Typen von Malware. Klicken Sie weiter auf die jeweilige Virenart, um Genaueres zu erfahren.</p>
...
<p>Datei-Viren stellen die klassische Form eines Computervirus dar. Sie befallen bestimmte Dateien, wie etwa ausführbare Programme, und vermehren sich beim Aufruf dieser Programmdateien.</p>
...
<div class="expand">
    ...
    <div class="expand-content" style="display: none;">
<p>„Trojanische Pferde“ oder „Trojaner“ werden genutzt, um weitere Schadprogramme auf Ihren Computer zu schleusen, um z.B.</p>
<ul>
<li>Daten und Passwörter auszuspionieren,</li>
<li>das System unbemerkt für Zugriffe von außen zu öffnen,</li>
<li>Ihren Rechner für Angriffe auf andere Systeme zu verwenden oder</li>
<li>Ihre Daten zu verschlüsseln und Sie dann zu erpressen.</li>
</ul>
...
<div class="expand">
    ...
    <div class="expand-content" style="display: none;">
<p>Die Virenart „Wurm“ ist ein selbständiges, selbstreproduzierendes Programm, das sich bevorzugt in Netzwerken ausbreitet und versucht, dessen Arbeit zu stören.</p>
...
<div class="expand">
    ...
    <div class="expand-content" style="display: none;">
<p>Bots (als Abkürzung für „robots“) sind selbständig arbeitende Computerprogramme, die ohne Zutun der Nutzer*innen aktiv sind. Problematisch ist dies, wenn sie im Verborgenen agieren. Ein im PC „versteckter“ Bot wird Angriffe auf Webseiten durchführen oder Daten Ihres Computers „stehlen“.</p>
...
<div class="expand">
    ...
    <div class="expand-content" style="display: none;">
<p>Ein Hoax ist kein Virus, sondern eine Art „schlechter Scherz“, oft im Kettenbriefformat. Sie werden durch eine Textnachricht aufgefordert, diese an andere weiterzuleiten. Dadurch wird die beabsichtigte Wirkung eines Virus entfaltet, nämlich die massenhafte Verbreitung. Kettenbriefe findet man heute vornehmlich in Sozialen Medien.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/02-lektion-viren.php" class="dd-item parent"><a href="../02-lektion-viren.php">2. Lektion Viren<i class="fas fa-check read-icon"></i></a><ul id="subsections-d17bb9556d8e63a32c5dce29f729f275">
          ...
          <li data-nav-id="/02-lektion-viren/02.typen-von-viren.php" class="dd-item active"><a href="../02-lektion-viren/02.typen-von-viren.php">Typen von Viren<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren/02.typen-von-viren.php" selected>Deutsch</option>
                  </select>
                </div>
