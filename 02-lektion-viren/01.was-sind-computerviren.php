...
<html lang="de">
  <head>
    ...
    <title>Was sind Computerviren? :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../02-lektion-viren/01.was-sind-computerviren.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../02-lektion-viren/02.typen-von-viren.php" title="Typen von Viren (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../02-lektion-viren.php" title="Viren (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Was sind Computerviren?</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-shield-virus"></i></div></div></div>


<p>Viren (auch „Schadprogramm“, „Malware“ etc. genannt) sind kleine Computer-Programme oder Programmteile, die unerwünschte Aktionen auslösen und verschiedenste Auswirkungen auf Ihr Computersystem haben können:</p>
<ul>
<li>In der harmlosesten Stufe sind Viren nur lästig oder stiften Verwirrung, z. B. durch ungewöhnliche Aktionen, die Ihre Daten aber nicht beschädigen.</li>
<li>Andere Viren nutzen Ihr System, in dem sie Programme missbrauchen, z.B. Ihr E-Mail-Programm verwenden, um E-Mails an alle Adressen in Ihrem Adressbuch zu senden oder diese abzugreifen.</li>
<li>Manche Viren spionieren Passwörter aus, verändern Dateien oder zerstören im schlimmsten Fall ganze Systeme.</li>
<li>Seit einiger Zeit gibt es verbreitetet Viren, die Ihre und die Daten Ihrer Behörde oder Einrichtung verschlüsseln. Der Schlüssel zum Entschlüsseln wird im Anschluss erpresserisch zum „Kauf“ angeboten (sog. Ransom-Ware; Ransom = Erpressung).</li>
</ul>
<p>Die Bandbreite ist also groß. Monatlich werden ca. acht Millionen Viren- und Virusvarianten in Umlauf gebracht. Längst liegen die durch Viren verursachten Schäden in Milliardenhöhe.</p>

<div class="box notices cstyle tip">
    <div class="box-label"><i class="fa-fw fas fa-lightbulb"></i> Gut zu wissen</div>
    <div class="box-content">
<p>Viren sind kleine Computerprogramme, die unerwünschte Aktionen auslösen</p>
    </div>
</div>
      ...
      <?php
        ...
        $htmlString = <<<EOT
          <ul class="topics">
            ...
            <li data-nav-id="/02-lektion-viren/01.was-sind-computerviren.php" class="dd-item active"><a href="../02-lektion-viren/01.was-sind-computerviren.php">Was sind Computerviren?<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren/01.was-sind-computerviren.php" selected>Deutsch</option>
                  </select>
                </div>
