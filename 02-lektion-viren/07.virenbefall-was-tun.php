...
<html lang="de">
  <head>
    ...
    <title>Virenbefall - was tun? :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../02-lektion-viren/07.virenbefall-was-tun.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../02-lektion-viren/08.zusammenfassung.php" title="Zusammenfassung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../02-lektion-viren/06.vorbeugung.php" title="Vorbeugung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Virenbefall - was tun?</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-shield-virus"></i></div></div></div>


<h3 id="dont-panic--ruhe-bewahren">Don&rsquo;t panic – Ruhe bewahren</h3>
<p>​	
<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p>Wenn Sie vermuten, dass sich ein Virus eingeschlichen hat, ist eine schnelle Reaktion gefragt, um größeren Schaden zu vermeiden. Wichtig ist dabei:</p>
<ul>
<li>Geraten Sie nicht in Panik!</li>
<li>Computer vom Netzwerk trennen, also Netzwerkkabel ziehen oder drahtlose Verbindung abschalten!</li>
<li>Auf keinen Fall eigene Bereinigungsaktionen durchführen!</li>
<li>Benachrichtigen Sie Ihre <a href="../ansprechpersonen.php">Ansprechperson</a>. Sie kümmert sich um die weiteren Schritte zur Beseitigung des Virus und zur Wiederherstellung betroffener Daten.</li>
<li>Wenn Sie Zugriff darauf haben, halten Sie die letzte Datensicherung bereit.</li>
<li>Wenn der Virus Sie zur Zahlung eines „Lösegelds“ auffordert, informieren Sie ebenfalls Ihre <a href="../ansprechpersonen.php">Ansprechperson</a>. Leisten Sie keinesfalls selbst Zahlungen! Im Zweifelsfall ist beides weg - Daten und Geld.</li>
</ul>
<p>​</p>
    </div>
</div></p>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/02-lektion-viren/07.virenbefall-was-tun.php" class="dd-item active"><a href="../02-lektion-viren/07.virenbefall-was-tun.php">Virenbefall - was tun?<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren/07.virenbefall-was-tun.php" selected>Deutsch</option>
                  </select>
                </div>
