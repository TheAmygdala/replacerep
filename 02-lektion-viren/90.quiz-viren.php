...
<html lang="de">
  <head>
    ...
    <title>Quiz - Viren :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../02-lektion-viren/90.quiz-viren.php">
    <div id="body" class="default-animation">
      ...
      <nav id="topbar" class="highlightable">
        <div>
             ...
             <a class="nav nav-next" href="../03-lektion-passwoerter.php" title="Passwörter (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
             </div> 
             EOT;
             echo filterSingleNodeHref($html);
             ?>
          <div class="navigation">
             <a class="nav nav-prev" href="../02-lektion-viren/08.zusammenfassung.php" title="Zusammenfassung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/02-lektion-viren/90.quiz-viren.php" class="dd-item active"><a href="../02-lektion-viren/90.quiz-viren.php">Quiz - Viren<i class="fas fa-check read-icon"></i></a></li></ul></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren/90.quiz-viren.php" selected>Deutsch</option>
                  </select>
                </div>
