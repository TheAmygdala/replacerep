...
<html lang="de">
  <head>
    ...
    <title>Infos / Ansprechpersonen :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./ansprechpersonen/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./ansprechpersonen.php">
    <div id="body" class="default-animation">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          ...
          <div class="navigation">
             <a class="nav nav-prev" href="./09-lektion-mein-arbeitsplatz/07.verhalten-im-schadensfall.php" title="Verhalten im Schadensfall (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-list"><i class="fas fa-user-shield"></i></div></div></div>
  ...
  <img src="./images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/ansprechpersonen.php" class="dd-item active"><a href="./ansprechpersonen.php">Infos / Ansprechpersonen<i class="fas fa-check read-icon"></i></a></li>
          </ul>
        EOT;
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/ansprechpersonen.php" selected>Deutsch</option>
                  </select>
                </div>
