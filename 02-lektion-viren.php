...
<html lang="de">
  <head>
    ...
    <title>Viren :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./02-lektion-viren/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./02-lektion-viren.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./02-lektion-viren/01.was-sind-computerviren.php" title="Was sind Computerviren? (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./01-lektion-e-mails/90.quiz-e-mails.php" title="Quiz - E-Mails (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<div class="article-subheading">Lektion 2</div>
<h1>Viren</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-list"><i class="fas fa-virus"></i></div></div></div>


<h2 id="schutz-vor-schadhaften-programmen">Schutz vor schadhaften Programmen</h2>
<p>In dieser Lektion lernen Sie,</p>
<ul>
<li>was ein Computervirus eigentlich ist und welche Typen von Viren existieren,</li>
<li>welche Infektionswege es gibt,</li>
<li>welche Risiken bestehen und welche Schäden entstehen können,</li>
<li>wie Sie Ihren PC und Ihre Behörde oder Einrichtung vor Viren schützen können,</li>
<li>wie Sie einen Virenbefall erkennen und</li>
<li>was Sie tun sollten, falls „es“ doch passiert ist</li>
</ul>
  ...
  <img src="./images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/02-lektion-viren.php" class="dd-item active parent"><a href="./02-lektion-viren.php">2. Lektion Viren<i class="fas fa-check read-icon"></i></a><ul id="subsections-d17bb9556d8e63a32c5dce29f729f275">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/02-lektion-viren.php" selected>Deutsch</option>
                  </select>
                </div>
