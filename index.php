...
<html lang="de">
  <head>
    ...
    <title>Start :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./">
    <div id="body" class="default-animation">
      ...
      <nav id="topbar" class="highlightable">
        ...
        <?php
             ...
             <a class="nav nav-next" href="./einleitung.php" title="Einleitung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
             </div> 
             EOT;
...
<h1 id="willkommen-bei-hahahugoshortcode-s0-hbhb">Willkommen bei BITS</h1>
<h1 id="hahahugoshortcode-s1-hbhb">Behörden-IT-Sicherheitstraining</h1>
<p>BITS 6.2.2 aus Winter 2022</p>
<h2 id="sicherheit-entsteht--wenn-alle-mitmachen">Sicherheit entsteht – wenn alle mitmachen!</h2>
<h3 id="das-sicherheitstraining-hahahugoshortcode-s5-hbhb-ist-konzipiert-für">Das Sicherheitstraining BITS ist konzipiert für</h3>
<ul>
<li>Behörden und Einrichtungen, die ihre Beschäftigten im sicheren Umgang mit dem Computer und dem Internet sensibilisieren wollen</li>
<li>die Beschäftigten von Behörden und Einrichtungen, die sich auch über die private sichere Nutzung von Computer und Internet informieren wollen</li>
</ul>
<p>Die Leitung Ihrer Behörde oder Einrichtung trägt die Verantwortung für die Informationssicherheit. Dieser Verantwortung kann sie jedoch nur gerecht werden, wenn alle Beschäftigten aufmerksam arbeiten und wissen, welche Gefahren die IT-Nutzung mit sich bringt und wie man diesen angemessen begegnet. Dies soll BITS vermitteln.</p>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/" selected>Deutsch</option>
                    <option lang="en" id="en" value="/en/">English</option>
                  </select>
                </div>
