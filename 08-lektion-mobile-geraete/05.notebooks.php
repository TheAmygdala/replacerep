...
<html lang="de">
  <head>
    ...
    <title>Notebooks :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/05.notebooks.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../08-lektion-mobile-geraete/06.mobiltelefone.php" title="Mobiltelefone (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../08-lektion-mobile-geraete/04.wlan-wireless-local-area-network.php" title="WLAN - Wireless Local Area Network (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h3 id="so-verhalten-sie-sich-richtig">So verhalten Sie sich richtig</h3>
<p>Viele Behörden und Einrichtungen stellen ihren Beschäftigten Smartphones oder Notebooks (Laptops, Tablets etc.) zur Verfügung, die oft bereits besondere Sicherheitseinstellungen enthalten. Folgendes sollten Sie beachten:</p>
<ul>
<li>Das Notebook mindestens einmal pro Woche mit dem Dienstnetz verbinden, um Software-Updates und Virenschutz-Signaturen einzuspielen.</li>
<li>Bei Fehlermeldungen des Virenscanners oder der Verschlüsselungssoftware sofort die <a href="../ansprechpersonen.php">Ansprechperson</a> benachrichtigen</li>
<li>Den Verlust des Endgeräts unverzüglich der <a href="../ansprechpersonen.php">Ansprechperson</a> und den Vorgesetzten melden.</li>
<li>Regelmäßig alle Daten sichern und gemäß ihrer Vertraulichkeitsklasse aufbewahren.</li>
<li>Falls vorhanden, das Notebook nur über das Programm zum sicheren Verbinden mit dem Dienstnetz (Virtuelles Privates Netzwerks, VPN) im Internet verwenden.</li>
<li>Gerät und Login-Informationen nicht an Dritte weitergeben oder von diesen nutzen lassen</li>
<li>Die Konfiguration des Notebooks nicht selbständig verändern</li>
<li>Nicht eigenmächtig Programme installieren</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/05.notebooks.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/05.notebooks.php">Notebooks<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/05.notebooks.php" selected>Deutsch</option>
                  </select>
                </div>
