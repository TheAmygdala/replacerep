...
<html lang="de">
  <head>
    ...
    <title>WLAN - Wireless Local Area Network :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/04.wlan-wireless-local-area-network.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../08-lektion-mobile-geraete/05.notebooks.php" title="Notebooks (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../08-lektion-mobile-geraete/03.heutige-kommunikationstechnologien.php" title="Heutige Kommunikationstechnologien (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>WLAN - Wireless Local Area Network</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-mobile-alt"></i></div></div></div>


<p>Bei Wireless LAN (WLAN) handelt es sich um eine Funknetzwerktechnik, die – wenn einmal aufgebaut – als kabelloser Netzwerkzugang funktioniert. Oftmals werden WLAN-Techniken in Besprechungsräumen und in Außenbüros eingesetzt. WLANs stehen aber auch in Cafés, Hotels oder anderen öffentlichen Bereichen bereit - und zuhause.</p>
<h4 id="so-verhalten-sie-sich-richtig-um-ein-abhören-zu-vermeiden">So verhalten Sie sich richtig, um ein Abhören zu vermeiden:</h4>
<ul>
<li>Wenn eine eigene drahtgebundene Netzwerkverbindung möglich ist, ist diese der WLAN-Technik vorzuziehen.</li>
<li>Wenn WLAN eingesetzt wird, muss grundsätzlich der höchstmögliche verfügbare Sicherheitsstandard zur Verschlüsselung des Zugangs gewählt werden (derzeit WPA3, mindestens WPA2).</li>
<li>Jeder ungewöhnliche Vorgang auf Ihrem Endgerät in Verbindung mit Funknetzen könnte ein Angriff sein; im Zweifel deaktivieren Sie die WLAN-Verbindung und informieren Sie Ihre <a href="../ansprechpersonen.php">Ansprechperson</a>.</li>
<li>Sollten Sie keine Kenntnis über die Funktion und das Einstellen dieser Mechanismen haben, so informieren Sie sich bitte bei Ihrer <a href="../ansprechpersonen.php">Ansprechperson</a>.</li>
<li>Besuchen Sie wenn möglich nur Internetseiten, die per <a href="../04-lektion-internet/05.schutz-vor-technischen-webinhalten.php">HTTPS</a> aufrufbar sind.</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/04.wlan-wireless-local-area-network.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/04.wlan-wireless-local-area-network.php">WLAN - Wireless Local Area Network<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/04.wlan-wireless-local-area-network.php" selected>Deutsch</option>
                  </select>
                </div>
