...
<html lang="de">
  <head>
    ...
    <title>Mobile Datenträger :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/08.mobile-datentraeger.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../08-lektion-mobile-geraete/09.zusammenfassung.php" title="Zusammenfassung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../08-lektion-mobile-geraete/07.apps-und-bring-your-own-device.php" title="Apps und &#34;Bring your own device&#34; (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Mobile Datenträger</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-mobile-alt"></i></div></div></div>


<h3 id="schnell-und-flexibel">Schnell und flexibel!</h3>
<p>Trotz Vernetzung, E-Mail und Internet kann es notwendig sein, Daten zwischen zwei nicht verbundenen Rechnern auszutauschen. Zu diesem Zweck werden gelegentlich mobile Datenträger in Form von USB-Sticks verwendet. Aber auch das eigene Smartphone kann zum Datenaustausch verwendet werden.</p>
<p>Dabei ist doppelte Vorsicht geboten:</p>
<ul>
<li>Zum einen können durch den Verlust des mobilen Datenträgers interne und vertrauliche Informationen an Unbefugte geraten.</li>
<li>Zum anderen können durch mobile Datenträger leicht Viren und andere schädliche Programme in das dienstliche Netz gelangen.</li>
</ul>
...
<ul>
<li>Auf mobilen Datenträgern sollten, wenn möglich, keine geheimen oder vertraulichen Daten gespeichert werden</li>
<li>Ist die Speicherung vertraulicher Daten notwendig, so sind diese zu verschlüsseln</li>
<li>Darüber hinaus sollten alle mobilen Datenträger vor der Verwendung mit einem aktuellen Virenscanner auf Viren untersucht werden</li>
<li>Mobile Datenträger müssen an einem sicheren Ort aufbewahrt werden</li>
<li>Der Verlust eines Datenträgers mit vertraulichen Daten ist unverzüglich den Vorgesetzten und der <a href="../ansprechpersonen.php">Ansprechperson</a> zu melden</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/08.mobile-datentraeger.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/08.mobile-datentraeger.php">Mobile Datenträger<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/08.mobile-datentraeger.php" selected>Deutsch</option>
                  </select>
                </div>
