...
<html lang="de">
  <head>
    ...
    <title>Mobiltelefone :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/06.mobiltelefone.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../08-lektion-mobile-geraete/07.apps-und-bring-your-own-device.php" title="Apps und &#34;Bring your own device&#34; (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../08-lektion-mobile-geraete/05.notebooks.php" title="Notebooks (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<p>Heute haben Handys umfangreiche, computerähnliche Funktionen. Entsprechend ist auch hier Vorsicht geboten, vor allem beim Speichern von Informationen auf dem Mobiltelefon:</p>
<ul>
<li>Beim Einschalten sollte immer die PIN-Abfrage erfolgen</li>
<li>Alle drahtlosen, nicht für die aktuelle Nutzung benötigten Kommunikationsmöglichkeiten ausschalten (Bluetooth, WLAN)</li>
<li>Ist die Speicherung vertraulicher Daten erforderlich und von Ihrer Behörde oder Einrichtung erlaubt, so sind diese zu verschlüsseln</li>
<li>Der Verlust eines Geräts mit vertraulichen Daten ist unverzüglich ihrer vorgesetzten Person und der <a href="../ansprechpersonen.php">Ansprechperson</a> zu melden</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/06.mobiltelefone.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/06.mobiltelefone.php">Mobiltelefone<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/06.mobiltelefone.php" selected>Deutsch</option>
                  </select>
                </div>
