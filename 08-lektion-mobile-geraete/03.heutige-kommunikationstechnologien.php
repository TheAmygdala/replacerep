...
<html lang="de">
  <head>
    ...
    <title>Heutige Kommunikationstechnologien :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/03.heutige-kommunikationstechnologien.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../08-lektion-mobile-geraete/04.wlan-wireless-local-area-network.php" title="WLAN - Wireless Local Area Network (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../08-lektion-mobile-geraete/02.besondere-gefahren.php" title="Besondere Gefahren (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Heutige Kommunikationstechnologien</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-mobile-alt"></i></div></div></div>


<h3 id="wer-hört-und-liest-mit">Wer hört und liest mit?</h3>
<p>Smartphones bieten nicht nur Möglichkeiten zum Telefonieren oder zur Adressverwaltung oder zum Nachrichtaustausch. Sie können auch zum Surfen im Internet oder zum Austausch von Kurznachrichten und Fotos verwendet werden.</p>
<p>Das alles geschieht kabellos mittels „Wireless“- (Drahtlos-) Technologien wie WLAN (siehe nächste Seite) und natürlich den Telefon- und Datennetzen. Problematisch ist dabei, dass oft schwer festzustellen ist, wer bei einer drahtlosen Datenübertragung mithört und ob dieser Zugang gerade ausspioniert wird. Gerade unverschlüsselte WLANs erlauben leicht Angriffe auf die über sie übermittelten Daten.</p>
<p>Bei vielen Anwendungen auf Smartphones („Apps“) verlangen diese bei der Installation weitgehende Rechte, die nicht immer benötigt werden, z.B. Zugriff auf Ihr Adressbuch.</p>
<p>Aus diesen Gründen haben die meisten Behörden und Einrichtungen erweiterte Sicherheitsrichtlinien für die Verwendung mobiler Geräte und die Nutzung von Funknetzen aufgestellt, die auf den folgenden Seiten beispielhaft beschrieben werden.</p>

<div class="box notices cstyle tip">
    <div class="box-label"><i class="fa-fw fas fa-lightbulb"></i> Gut zu wissen</div>
    <div class="box-content">
<p><strong>Bluetooth</strong> = Dient der spontanen drahtlosen Verbindung von Endgeräten; Reichweite: 10 – 100 Meter.</p>
<p><strong>WLAN</strong> = Wireless Local Area Network; Verbindung mehrerer Endgeräte über einen lokalen Sender (Access Point oder Router); Reichweite: 50+ Meter.</p>
<p><strong>UMTS (3G)</strong> =  Handy-Netz für Sprache und Daten (Universal Mobile Telecommunications System); Daten-Geschwindigkeit von bis zu 21 MBit/s.</p>
<p><strong>LTE</strong> = Long Term Evolution; Weiterentwicklung von UMTS mit bis zu 300 MBit/s.</p>
<p><strong>LTE Advanced (4G)</strong> = Weiterentwicklung von LTE mit bis zu 1.000 MBit/s.</p>
<p><strong>5G</strong> = Weiterentwicklung von LTE mit bis zu 10.000 MBit/s.</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/08-lektion-mobile-geraete.php" class="dd-item parent"><a href="../08-lektion-mobile-geraete.php">8. Lektion Mobile Geräte<i class="fas fa-check read-icon"></i></a><ul id="subsections-6e49a72e993d6de5173dd8cf540c0e8f">
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/03.heutige-kommunikationstechnologien.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/03.heutige-kommunikationstechnologien.php">Heutige Kommunikationstechnologien<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/03.heutige-kommunikationstechnologien.php" selected>Deutsch</option>
                  </select>
                </div>
