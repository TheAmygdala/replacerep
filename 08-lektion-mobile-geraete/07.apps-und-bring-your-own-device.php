...
<html lang="de">
  <head>
    ...
    <title>Apps und &#34;Bring your own device&#34; :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/07.apps-und-bring-your-own-device.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../08-lektion-mobile-geraete/08.mobile-datentraeger.php" title="Mobile Datenträger (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../08-lektion-mobile-geraete/06.mobiltelefone.php" title="Mobiltelefone (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Apps und &#34;Bring your own device&#34;</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-mobile-alt"></i></div></div></div>


<p>Stellt Ihnen Ihre Behörde oder Einrichtung ein Smartphone zur Verfügung, das Sie auch privat nutzen dürfen? Oder erlaubt sie die dienstliche Nutzung Ihres privaten Handys („Bring your own device - BYOD“)? Dann müssen Sie sich an die internen Sicherheitsvorgaben halten!</p>
<p>Insbesondere müssen Sie darauf achten, dass dienstliche und private Daten nicht vermischt werden. Außerdem kann über viele Apps (Anwendungen auf Ihrem Smartphone) Ihr Nutzungsverhalten ausgespäht werden. Viele Apps wollen mehr Rechte haben, als es für ihre Nutzung erforderlich ist. Verweigern Sie den Apps diese Rechte oder verzichten Sie ganz auf sie.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Installieren Sie nur solche Apps, die Sie benötigen und löschen Sie die anderen</li>
<li>Schränken Sie die Zugriffsberechtigungen für Ihre Kontakte, Standortangaben etc. bei Apps möglichst ein</li>
<li>Verarbeiten Sie keine dienstlichen Daten in privaten Apps</li>
<li>Auch Messenger-Apps wie z. B. WhatsApp, die Sie privat installieren und verwenden, dürfen nicht für dienstliche Zwecke genutzt werden</li>
<li>Nutzen Sie nach Möglichkeit verschiedene Benutzerprofile für den privaten und den dienstlichen Gebrauch</li>
<li>Löschen Sie nicht mehr benötigte WLAN-Netzwerke in den Netzwerk-Einstellungen des Geräts</li>
<li>Installieren Sie alle verfügbaren Updates für das Gerät und die Apps</li>
<li>Der Verlust eines Geräts mit vertraulichen Daten ist unverzüglich den Vorgesetzten und der <a href="../ansprechpersonen.php">Ansprechperson</a> zu melden</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/07.apps-und-bring-your-own-device.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/07.apps-und-bring-your-own-device.php">Apps und &#34;Bring your own device&#34;<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/07.apps-und-bring-your-own-device.php" selected>Deutsch</option>
                  </select>
                </div>
