...
<html lang="de">
  <head>
    ...
    <title>Quiz - Mobile Geräte :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/90.quiz-mobile-geraete.php">
...
> Die Nutzung durch fremde Geräte birgt große Gefahren für Ihre Behörde oder Einrichtung.

1. [ ] Sie prüfen, ob der Dienstleister einen aktuelle Virenscanner hat und lassen ihn dann an einen Netzwerk-Anschluss.

	>Nein. Bei den meisten Behörden und Einrichtungen dürfen nur eigene dienstliche Notebooks an das Netzwerk angeschlossen werden. Die Anbindung fremder Geräte ist z.B. zum Schutz vor Viren nicht erlaubt.
   
2. [x] Sie geben dem Dienstleister keinen Netzwerk-Zugang, da nur einrichtungseigene Notebooks angeschlossen werden dürfen.

	>**Richtige Antwort**
3. [ ] Sie lassen den Dienstleister an einen Netzwerk-Anschluss, falls er einen Auftrag Ihrer Behörde oder Einrichtung vorzeigt.

	>Nein. Bei den meisten Behörden und Einrichtungen dürfen nur eigene dienstliche Notebooks an das Netzwerk angeschlossen werden. Die Anbindung fremder Geräte ist z.B. zum Schutz vor Viren nicht erlaubt.

## Ihnen ist auf einer Dienstreise ein Smartphone mit dienstlichen Informationen gestohlen worden. Wie verhalten Sie sich?

> Ihre Behörde oder Einrichtung muss informiert werden.
...
3. [ ] Sie zeigen den Diebstahl bei der Polizei an und kaufen sich ein neues Smartphone.
	...
	>Nein. Da auf dem Smartphone dienstliche Daten gespeichert sind, muss zusätzlich Ihre Behörde oder Einrichtung über den Verlust informiert werden.
...
2. [ ] Ich kopiere die Daten vom USB-Stick auf meinen privaten Laptop und sende sie dann an mein dienstliches E-Mail-Postfach.
	...
	>Nein. Abgesehen davon, dass dienstliche Daten nicht auf privaten Endgeräten verarbeitet werden dürfen, können auf diesem Weg Viren vom USB-Stick in das Netzwerk Ihrer Behörde oder Einrichtung gelangen.
...
3. [x] Falls wir beide im gleichen [VPN](/09-lektion-mein-arbeitsplatz/01.sicherer-arbeitsplatz.php) sind, stelle ich die Datei über ein Gruppenlaufwerk oder eine interne E-Mail bereit. Andernfalls verschlüssele ich die Datei und sende sie per E-Mail an die Kollegin, das Passwort teile ich ihr mündlich mit.
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/90.quiz-mobile-geraete.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/90.quiz-mobile-geraete.php">Quiz - Mobile Geräte<i class="fas fa-check read-icon"></i></a></li></ul></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/90.quiz-mobile-geraete.php" selected>Deutsch</option>
                  </select>
                </div>
