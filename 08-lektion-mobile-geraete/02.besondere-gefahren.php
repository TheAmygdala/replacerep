...
<html lang="de">
  <head>
    ...
    <title>Besondere Gefahren :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/02.besondere-gefahren.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../08-lektion-mobile-geraete/03.heutige-kommunikationstechnologien.php" title="Heutige Kommunikationstechnologien (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../08-lektion-mobile-geraete/01.einleitung.php" title="Einleitung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Besondere Gefahren</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-mobile-alt"></i></div></div></div>


<h3 id="kleine-geräte-können-leicht-gestohlen-werden-oder-verloren-gehen">Kleine Geräte können leicht gestohlen werden oder verloren gehen</h3>
<p>Grundsätzlich unterliegen mobile Geräte und die auf ihnen gespeicherten Daten den gleichen Sicherheitsbestimmungen wie alle anderen IT-Systeme Ihrer Behörde oder Einrichtung.</p>
<p>Mobile Geräte und Speichermedien unterliegen jedoch besonderen Gefahren, denn</p>
<ul>
<li>sie werden häufig auch außerhalb des Dienstgebäudes verwendet und</li>
<li>sie können leichter vergessen, verloren oder gestohlen werden; dadurch können vertrauliche Daten schnell in falsche Hände geraten.</li>
</ul>
<p>Diese Gefahren gilt es mit geeigneten Sicherheitsmaßnahmen zu verringern.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p><strong>Gefahren bei Verlust mobiler Geräte:</strong></p>
<ul>
<li>der Verlust wird möglicherweise nicht sofort bemerkt</li>
<li>vertrauliche Informationen können unkontrolliert preisgegeben werden</li>
<li>die Verlustumstände sind schwer nachzuvollziehen</li>
<li>der Verlust ist ein finanzieller Schaden</li>
<li>wer das Geräte stiehlt oder findet hat viel Zeit, die Daten zu analysieren</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/02.besondere-gefahren.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/02.besondere-gefahren.php">Besondere Gefahren<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/02.besondere-gefahren.php" selected>Deutsch</option>
                  </select>
                </div>
