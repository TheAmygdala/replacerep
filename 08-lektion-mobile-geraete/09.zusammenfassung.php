...
<html lang="de">
  ...
  <body class="mobile-support default" data-url="../08-lektion-mobile-geraete/09.zusammenfassung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../08-lektion-mobile-geraete/90.quiz-mobile-geraete.php" title="Quiz - Mobile Geräte (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../08-lektion-mobile-geraete/08.mobile-datentraeger.php" title="Mobile Datenträger (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<p>Mobile Geräte stellen aufgrund ihrer Größe und Beweglichkeit ein besonderes Sicherheitsrisiko dar. Deshalb haben die meisten Behörden und Einrichtungen Regeln für den Umgang mit diesen Geräten aufgestellt, die hier sinngemäß zusammengefasst sind:</p>
<ul>
<li>Passwortschutz bzw. PIN-Abfrage aktivieren</li>
<li>Mobile Datenträger immer zuerst auf Viren untersuchen</li>
<li>Mobile Geräte  und Datenträger sicher aufbewahren</li>
<li>Für regelmäßige Software-Updates und Konfigurationsüberprüfungen sorgen</li>
<li>Nicht benötigte drahtlose Kommunikationsmöglichkeiten möglichst deaktivieren</li>
<li>Verlust von mobilen Geräten sofort der <a href="../ansprechpersonen.php">Ansprechperson</a> und den Vorgesetzten melden</li>
<li>Keine selbständigen Konfigurationsänderungen bei Dienstgeräten durchführen</li>
<li>Keine vertraulichen oder geheimen Daten speichern, es sei denn sie sind verschlüsselt</li>
<li>Dienstliche und private Daten nicht vermischen</li>
</ul>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p>Falls in Ihrer Behörde oder Einrichtung eine Richtlinie zum Umgang mit Mobilen Geräten bzw. Datenträgern besteht, ist diese zu beachten.</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/08-lektion-mobile-geraete/09.zusammenfassung.php" class="dd-item active"><a href="../08-lektion-mobile-geraete/09.zusammenfassung.php">Zusammenfassung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete/09.zusammenfassung.php" selected>Deutsch</option>
                  </select>
                </div>
