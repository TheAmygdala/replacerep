...
<html lang="de">
  <head>
    ...
    <title>Tags :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./tags/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./tags.php">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/tags.php" selected>Deutsch</option>
                    <option lang="en" id="en" value="/en/tags.php">English</option>
                  </select>
                </div>
