...
<html lang="de">
  <head>
    ...
    <title>Vorteile und Gefahren :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../07-lektion-cloud/03.vorteile-und-gefahren.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../07-lektion-cloud/04.cloud-dienste-sicher-nutzen.php" title="Cloud-Dienste sicher nutzen (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../07-lektion-cloud/02.ueberblick-cloud-dienste.php" title="Überblick Cloud-Dienste (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Vorteile und Gefahren</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-cloud-download-alt"></i></div></div></div>


<h3 id="vorteile-von-cloud-diensten">Vorteile von Cloud-Diensten</h3>
<p>Cloud-Dienste werden oft so angeboten, dass die Kundinnen und Kunden die Dienste sehr kurzfristig in Anspruch nehmen, erweitern oder verringern können. Idealerweise merken die Nutzerinnen und Nutzer nicht, dass z.B. weiterer Speicher wegen verstärkter Nutzung hinzugeschaltet wird, um die Dienste in der versprochenen Qualität anzubieten.</p>
<p>Die Kundinnen und Kunden müssen nicht selbst Hard- und Software betreiben, die manchmal aufwändig eingerichtet werden muss. Dies ist besonders von Vorteil, wenn der Umfang der Nutzung wieder verringert wird. Bei den kostenpflichtigen Cloud-Diensten zahlt man regelmäßig nur für den laufenden Betrieb, der in kurzen Zeitspannen abgerechnet wird - teilweise nach Stunden!</p>
<p>Die Dienste werden in Netzwerken bzw. über das Internet von spezialisierten Anbieter*innen betrieben. Diese betreuen die Hardware und die Software in dafür ausgelegten Rechenzentren - die Nutzerinnen und Nutzer müssen sich darum nicht kümmern.</p>
<h3 id="gefahren-bei-cloud-diensten">Gefahren bei Cloud-Diensten</h3>
<p>Wenn man Cloud-Dienste nicht auf eigenen Rechnern betreibt, müssen die Daten Dritten anvertraut werden.</p>
<p>Während Privatpersonen häufig auf kostenfreie Angebote zurückgreifen, bei denen sie die Dienste mit einer Vielzahl von anderen teilen („Public Cloud“) und die oft im Ausland betrieben werden, wählen Behörden und andere Einrichtungen regelmäßig „Private Clouds“. Sie haben dann Nutzungsverträge, bei denen die Datensicherheit und der Zugangsschutz neben der Verfügbarkeit, die für Privatanwender oft im Vordergrund steht, wesentliche Vertragsinhalte sind.</p>
<p>Andernfalls besteht die Gefahr, dass</p>
<ul>
<li>Dritte unberechtigt Zugang zu den Daten haben,</li>
<li>die Anbieter*innen die Daten für eigene Zwecke nutzen,</li>
<li>Daten verloren gehen bzw. nicht zeitgerecht verfügbar sind,</li>
<li>unbemerkt Kopien von Daten durch die Anbieter*innen angelegt und gegebenenfalls nicht gelöscht werden.</li>
</ul>
<p>Mit den richtigen Schutzmaßnahmen kann diesen Gefahren vorgebeugt werden!</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p><strong>Wer liest mit?</strong></p>
<p>Wissen Sie, wer Ihre persönlichen Daten in Public Clouds nutzt bzw. nutzen darf?</p>
<p>Das Kleingedruckte in den Allgemeinen Geschäftsbedingungen kann so manche Überraschung bereiten!</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/07-lektion-cloud/03.vorteile-und-gefahren.php" class="dd-item active"><a href="../07-lektion-cloud/03.vorteile-und-gefahren.php">Vorteile und Gefahren<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/07-lektion-cloud/03.vorteile-und-gefahren.php" selected>Deutsch</option>
                  </select>
                </div>
