...
<html lang="de">
  <head>
    ...
    <title>Quiz - Cloud :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../07-lektion-cloud/90.quiz-cloud.php">
    <div id="body" class="default-animation">
      ...
      <nav id="topbar" class="highlightable">
        <div>
             ...
             <a class="nav nav-next" href="../08-lektion-mobile-geraete.php" title="Mobile Geräte (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
             </div> 
             EOT;
             echo filterNavArrow($html);
             ?>
          <div class="navigation">
             <a class="nav nav-prev" href="../07-lektion-cloud/05.zusammenfassung.php" title="Zusammenfassung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
1. [ ] Das brauche ich nicht, das macht der Dienstanbieter.
	...
	>In Behörden und Einrichtungen gibt es für die dienstlichen Systeme regelmäßig sichere Voreinstellungen. Für Ihre persönlichen Daten müssen Sie selbst dafür sorgen, dass diese sicher in der Cloud liegen.
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/07-lektion-cloud/90.quiz-cloud.php" class="dd-item active"><a href="../07-lektion-cloud/90.quiz-cloud.php">Quiz - Cloud<i class="fas fa-check read-icon"></i></a></li></ul></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/07-lektion-cloud/90.quiz-cloud.php" selected>Deutsch</option>
                  </select>
                </div>
