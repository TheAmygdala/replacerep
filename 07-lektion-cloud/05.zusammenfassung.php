...
<html lang="de">
  ...
  <body class="mobile-support default" data-url="../07-lektion-cloud/05.zusammenfassung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../07-lektion-cloud/90.quiz-cloud.php" title="Quiz - Cloud (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../07-lektion-cloud/04.cloud-dienste-sicher-nutzen.php" title="Cloud-Dienste sicher nutzen (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<p>Cloud-Dienste sind heute Alltag. Sie bieten eine Fülle von Vorteilen, die kostengünstig eine hohe Verfügbarkeit und eine schnelle Anpassung von Kapazitäten zu niedrigen Preisen bieten.</p>
<p>Ihre Behörde oder Einrichtung wählt Cloud-Dienste sorgfältig aus und sorgt sich aktiv um die Sicherheit der Daten.</p>
<p>Vertrauen Sie Ihre privaten Daten Dritten an, sollten Sie prüfen, ob die Zugangsmöglichkeiten der Anbieter*innen oder anderer ausgeschlossen oder zumindest nicht schädlich sind. Im Zweifelsfall gilt: Lieber die Daten zuhause so speichern, dass nur Sie Zugang dazu haben.</p>

<div class="box notices cstyle tip">
    <div class="box-label"><i class="fa-fw fas fa-lightbulb"></i> Gut zu wissen</div>
    <div class="box-content">
<p><strong>Was sind Ihre Daten wert?</strong></p>
<p>Wie auch bei <a href="../06-lektion-social-media.php">Social Media</a> gilt, dass der Preis, den Sie für kostenlose Dienste zahlen, Ihre Daten selbst oder Ihr Nutzungsverhalten ist. Wägen Sie dies gegen (vermeintlich) günstige Angebote ab.</p>
<ul>
<li>Verschlüsseln Sie möglichst Ihre Cloud-Daten!</li>
<li>Halten Sie Kopien zuhause vor!</li>
<li>Im Zweifelsfall: Datei nicht in die Cloud.</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/07-lektion-cloud/05.zusammenfassung.php" class="dd-item active"><a href="../07-lektion-cloud/05.zusammenfassung.php">Zusammenfassung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/07-lektion-cloud/05.zusammenfassung.php" selected>Deutsch</option>
                  </select>
                </div>
