...
<html lang="de">
  <head>
    ...
    <title>Cloud-Dienste :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../07-lektion-cloud/01.einleitung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../07-lektion-cloud/02.ueberblick-cloud-dienste.php" title="Überblick Cloud-Dienste (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../07-lektion-cloud.php" title="Cloud (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h3 id="was-sind-cloud-dienste">Was sind Cloud-Dienste?</h3>
<p>Das Internet ist für die meisten von uns nur einen Mausklick oder Fingerdruck entfernt, sei es vom Arbeitsplatzrechner, sei es vom Smartphone aus. Die Übertragungsgeschwindigkeiten und die Speichermöglichkeiten im Internet sind mittlerweile so gut, dass bestimmte Angebote direkt im Internet genutzt werden können, ohne sie lokal zu installieren.</p>
<p>Diese Angebote reichen von Speicherplatz für Fotos oder Videos bis hin zur Möglichkeit, Computerprogramme, die im Internet liegen, über den Browser so zu nutzen, als wären sie vor Ort installiert. Die Zahl der Nutzerinnen und Nutzer ist dabei grundsätzlich beliebig.</p>
<p>Auch Behörden und andere Einrichtungen nutzen heute bereits Cloud-Dienste! Auf der folgenden Seite sind ein paar Beispiele für Cloud-Dienste aufgeführt.</p>

<div class="box notices cstyle tip">
    <div class="box-label"><i class="fa-fw fas fa-lightbulb"></i> Gut zu wissen</div>
    <div class="box-content">
<p><strong>Heiter bis wolkig</strong></p>
<p>Cloud-Dienste bieten für eine Vielzahl von Personen - oft kostenfrei - die Möglichkeit, über das Internet Daten und Programme zu nutzen. Die damit verbundene hohe Verfügbarkeit wird bei den kostenfreien Diensten manchmal damit erkauft, dass auch deren Anbieter Zugriff auf die Daten haben.</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/07-lektion-cloud/01.einleitung.php" class="dd-item active"><a href="../07-lektion-cloud/01.einleitung.php">Cloud-Dienste<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/07-lektion-cloud/01.einleitung.php" selected>Deutsch</option>
                  </select>
                </div>
