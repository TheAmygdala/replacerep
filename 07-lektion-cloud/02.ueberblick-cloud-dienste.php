...
<html lang="de">
  <head>
    ...
    <title>Überblick Cloud-Dienste :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../07-lektion-cloud/02.ueberblick-cloud-dienste.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../07-lektion-cloud/03.vorteile-und-gefahren.php" title="Vorteile und Gefahren (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../07-lektion-cloud/01.einleitung.php" title="Cloud-Dienste (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Überblick Cloud-Dienste</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-cloud-download-alt"></i></div></div></div>


<p>Zu den typischen Cloud-Diensten zählen u.a.</p>
<ul>
<li>Speicher (z.B. für Fotos)</li>
<li>Anwendungen (z.B. Bildbearbeitungsprogramme)</li>
<li>Rechenleistungen (z.B. Internet-Server für eine eigene Homepage)</li>
</ul>
<p>Bei einigen dieser Dienste ist es den Anbieter*innen gleich, für welchen konkreten Zweck sie genutzt werden - die freie Nutzbarkeit ist dann Teil des Geschäftsmodells.</p>
<p>Cloud-Dienste werden sowohl kostenpflichtig als auch kostenfrei angeboten. Bei den kostenfreien Angeboten teilt man sich die Dienste mit Dritten, bei den kostenpflichtigen werden - je nach Vertrag - die erforderlichen Betriebsmittel exklusiv zur Verfügung gestellt.</p>
<p>Begrifflich unterscheidet man entsprechend zwischen</p>
<ul>
<li>„<strong>Private</strong> Cloud“ - exklusive Bereitstellung der Betriebsmittel (Speicherplatz, Rechenleistung etc.) für die beauftragende Stelle</li>
<li>„<strong>Public</strong> (Öffentliche) Cloud“ - übergreifende Bereitstellung der Betriebsmittel für jedermann</li>
</ul>
<p>Deutsche Behörden und Einrichtungen nutzen regelmäßig „Private Clouds“. Über eigene Rechenzentren oder solche öffentlich-rechtlich betriebener Rechenzentren werden zentrale Dienste wie z.B. E-Mail, aber auch Web-Server oder Speicherplatz als „Private Cloud“ behördenintern und in Deutschland betrieben.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/07-lektion-cloud/02.ueberblick-cloud-dienste.php" class="dd-item active"><a href="../07-lektion-cloud/02.ueberblick-cloud-dienste.php">Überblick Cloud-Dienste<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/07-lektion-cloud/02.ueberblick-cloud-dienste.php" selected>Deutsch</option>
                  </select>
                </div>
