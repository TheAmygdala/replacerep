...
<html lang="de">
  <head>
    ...
    <title>Cloud-Dienste sicher nutzen :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../07-lektion-cloud/04.cloud-dienste-sicher-nutzen.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../07-lektion-cloud/05.zusammenfassung.php" title="Zusammenfassung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../07-lektion-cloud/03.vorteile-und-gefahren.php" title="Vorteile und Gefahren (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Cloud-Dienste sicher nutzen</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-cloud-download-alt"></i></div></div></div>


<p>Sie können davon ausgehen, dass Ihre Behörde oder Einrichtung, wenn sie Cloud-Dienste nutzt, die diese sorgfältig ausgewählt hat. Hierbei hat sie Vorgaben formuliert und sich versichert, dass die geschilderten Gefahren beherrschbar sind.</p>
<p>Wenn Sie Cloud-Dienste privat nutzen möchten, sollten Sie sich folgende Fragen stellen:</p>
<ul>
<li>Welche Daten will ich in die Cloud geben? Urlaubsfotos - oder auch Fotos, die ich nicht allen zeigen würde? Mein Tagebuch oder nur meinen Einkaufszettel?</li>
<li>Wem will ich die Daten anvertrauen? Einem Unternehmen, das strengen Datenschutzgesetzen unterliegt? Oder einem Unternehmen, das auch Dritten meine Daten offenbart?</li>
<li>Macht mir der Verlust der Daten etwas aus? Wenn ja, sollte ich zuhause Kopien behalten.</li>
</ul>
<p>Bedenken Sie, dass oft schon auf Ihrem Smartphone oder Ihrem privaten Computer Cloud-Dienste des Herstellers installiert sind und Ihre Daten und manchmal auch Ihr Nutzungsverhalten (z.B. Anrufprotokolle) von diesem gespeichert werden!</p>

<div class="box notices cstyle tip">
    <div class="box-label"><i class="fa-fw fas fa-lightbulb"></i> Gut zu wissen</div>
    <div class="box-content">
<p>Wenn Sie sich privat für die Nutzung von Cloud-Diensten entschieden haben, sollten Sie folgende Sicherheitsmaßnahmen treffen:</p>
<ul>
<li>Informieren Sie sich über die Anbieter*innen - verfügt das Rechenzentrum über Sicherheitszertifikate, z.B. nach „BSI IT-Grundschutz“?</li>
<li>Verzichten Sie auf Anbieter*innen, denen Sie Nutzungsrechte an Ihren Inhalten einräumen.</li>
<li>Speichern Sie keine hochsensiblen Daten in der Cloud.</li>
<li>Verwenden Sie sichere Passwörter.</li>
<li>Laden Sie möglichst nur Daten in die Cloud, die Sie vorher mit einem Verschlüsselungsprogramm verschlüsselt haben.</li>
<li>Halten Sie zuhause Kopien vor.</li>
<li>Vergeben Sie Zugriffsrechte an Dritte mit Bedacht.</li>
</ul>
    </div>
</div>
...
<div class="box notices cstyle note">
    ...
    <div class="box-content">
<p>Dienstliche Daten dürfen selbstverständlich nur im dienstlichen Umfeld verarbeitet werden, nicht in „Ihrer“ Cloud!</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/07-lektion-cloud.php" class="dd-item parent"><a href="../07-lektion-cloud.php">7. Lektion Cloud<i class="fas fa-check read-icon"></i></a><ul id="subsections-34918d1cd94a60ac0b2441e8b9ec5827">
          ...
          <li data-nav-id="/07-lektion-cloud/04.cloud-dienste-sicher-nutzen.php" class="dd-item active"><a href="../07-lektion-cloud/04.cloud-dienste-sicher-nutzen.php">Cloud-Dienste sicher nutzen<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/07-lektion-cloud/04.cloud-dienste-sicher-nutzen.php" selected>Deutsch</option>
                  </select>
                </div>
