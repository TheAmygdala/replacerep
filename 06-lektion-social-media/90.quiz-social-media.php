...
<html lang="de">
  <head>
    ...
    <title>Quiz - Social Media :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../06-lektion-social-media/90.quiz-social-media.php">
    <div id="body" class="default-animation">
      ...
      <nav id="topbar" class="highlightable">
        <div>
             ...
             <a class="nav nav-next" href="../07-lektion-cloud.php" title="Cloud (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
             </div> 
             EOT;
             echo filterNavArrow($html);
             ?>
          <div class="navigation">
             <a class="nav nav-prev" href="../06-lektion-social-media/03.social-media-sicher-nutzen.php" title="Social Media sicher nutzen (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/06-lektion-social-media/90.quiz-social-media.php" class="dd-item active"><a href="../06-lektion-social-media/90.quiz-social-media.php">Quiz - Social Media<i class="fas fa-check read-icon"></i></a></li></ul></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/06-lektion-social-media/90.quiz-social-media.php" selected>Deutsch</option>
                  </select>
                </div>
