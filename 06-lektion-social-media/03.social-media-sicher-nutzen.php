...
<html lang="de">
  <head>
    ...
    <title>Social Media sicher nutzen :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../06-lektion-social-media/03.social-media-sicher-nutzen.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../06-lektion-social-media/90.quiz-social-media.php" title="Quiz - Social Media (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../06-lektion-social-media/02.geschaeftsmodell.php" title="Geschäftsmodell (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Social Media sicher nutzen</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-share"></i></div></div></div>


<p>Social Media bieten eine Vielzahl von Möglichkeiten, schnell und einfach Informationen mitzuteilen. Der besondere Reiz liegt darin, dass alle mitmachen können und die Dienste oft kostenlos sind.</p>
<p>Werden die Social Media-Dienste kostenlos von Unternehmen angeboten, besteht der Preis oft in der (ungefragten) Übermittlung von Nutzerdaten. Man darf nie vergessen, dass einmal im Internet preisgegebene Informationen nicht mehr zu löschen sind. Außerdem können Informationen zu Ihrer Person genutzt werden, um über Sie Angriffe auf Ihre Behörde oder Einrichtung vorzubereiten (über das so genannte <a href="../03-lektion-passwoerter/02.gefahren.php#social-engineering">Social Engineering</a>).</p>
<p>Wenn Sie persönliche Daten wie Fotos oder Kommentare ins Internet stellen, müssen Sie davon ausgehen, dass Sie deren Verbreitung nicht mehr kontrollieren können.</p>
<p>Die Möglichkeiten, Social Media so zu nutzen, dass möglichst wenig personenbezogene Daten übertragen werden, sind eingeschränkt. Viele der Dienste leben davon, dass die Nutzerinnen und Nutzer persönliche Daten offenbaren.</p>
<p>Falls Sie nicht auf Social Media verzichten wollen:</p>
<ul>
<li>Verwenden Sie nicht Ihren echten Namen (dies lassen allerdings nicht alle Anbieter zu)</li>
<li>Ändern Sie die Einstellungen so ab, dass nicht alle, sondern nur Ihre Bekannten Ihre Daten einsehen können</li>
<li>Stellen Sie nur Informationen ein, die Sie auch einer völlig fremden Person erzählen würden und die Sie nie mehr löschen wollen - auch nicht in zehn Jahren</li>
<li>Löschen Sie regelmäßig die Cookies in Ihrem Browser</li>
<li>Die meisten Browser erlauben „privates Surfen“, bei dem z.B. Cookies beim Schließen gelöscht werden - nutzen Sie diese Funktion!</li>
<li>Nehmen Sie nur Freundschaftsanfragen an, wenn Sie sicher sind, wer anfragt</li>
<li>Verwenden Sie ein sicheres Passwort (Informationen hierzu in der Lektion <a href="../03-lektion-passwoerter.php">Passwörter</a>)</li>
</ul>

<div class="box notices cstyle tip">
    <div class="box-label"><i class="fa-fw fas fa-lightbulb"></i> Gut zu wissen</div>
    <div class="box-content">
<p><strong>Freud und Leid</strong></p>
<ul>
<li>So hilfreich viele der Social Media-Dienste auch sind - die kommerziellen Anbieter wollen mit Ihren Daten Geld verdienen.</li>
<li>Außerdem besteht die Gefahr, dass Ihre Informationen für gezielte Angriffe missbraucht werden.</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/06-lektion-social-media.php" class="dd-item parent"><a href="../06-lektion-social-media.php">6. Lektion Social Media<i class="fas fa-check read-icon"></i></a><ul id="subsections-165e1ba5c5785dd7976d9834642ffec7">
          ...
          <li data-nav-id="/06-lektion-social-media/03.social-media-sicher-nutzen.php" class="dd-item active"><a href="../06-lektion-social-media/03.social-media-sicher-nutzen.php">Social Media sicher nutzen<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/06-lektion-social-media/03.social-media-sicher-nutzen.php" selected>Deutsch</option>
                  </select>
                </div>
