...
<html lang="de">
  <head>
    ...
    <title>Passwörter nicht weitergeben :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../09-lektion-mein-arbeitsplatz/02.passwoerter-nicht-weitergeben.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../09-lektion-mein-arbeitsplatz/03.zugang-sichern.php" title="Zugang sichern (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../09-lektion-mein-arbeitsplatz/01.sicherer-arbeitsplatz.php" title="Sicherer Arbeitsplatz (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Passwörter nicht weitergeben</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-laptop"></i></div></div></div>


<p>Ihnen anvertraute oder von Ihnen erzeugte Passwörter dürfen Sie keinesfalls weitergeben. Es ist auch verboten, sie auf Zettel aufzuschreiben und in Schubladen, unter Schreibtischunterlagen o.ä. – also letztlich für Dritte zugänglich – aufzubewahren!</p>
<p>Passwörter sind personengebunden. Das heißt: Alle berechtigten Personen können über die zuständige Organisationseinheit ein eigenes Passwort erhalten. Sie benötigen nicht das Ihrige!</p>
<p>Falls Sie Schwierigkeiten mit der Bedienung passwortgeschützter Daten oder Anwendungen haben, kann die zuständige Einheit auch ohne Kenntnis Ihres persönlichen Passworts Hilfe leisten.</p>
<p>Falls Sie befürchten, dass eine andere Person Ihr Passwort kennt, ändern Sie es unverzüglich ab.</p>
<p>Mehr Informationen finden Sie in der Lektion <a href="../03-lektion-passwoerter.php">Passwörter</a>.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Geben Sie nie ein Passwort weiter!</li>
<li>Bewahren Sie Ihr Passwort nur an einem Ort auf: In Ihrem Kopf, allenfalls noch in einem <a href="../03-lektion-passwoerter/04.werkzeuge-fuer-passwoerter.php#passwort-manager">Passwort-Manager</a></li>
<li>Geben Sie Kennungen zu Ihren Fachanwendungen nicht an Kolleginnen oder Kollegen weiter!</li>
<li>Und nutzen Sie <strong>sichere</strong> Passwörter und die Zwei-Faktoren-Authentisierung (wenn angeboten),</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/09-lektion-mein-arbeitsplatz/02.passwoerter-nicht-weitergeben.php" class="dd-item active"><a href="../09-lektion-mein-arbeitsplatz/02.passwoerter-nicht-weitergeben.php">Passwörter nicht weitergeben<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/09-lektion-mein-arbeitsplatz/02.passwoerter-nicht-weitergeben.php" selected>Deutsch</option>
                  </select>
                </div>
