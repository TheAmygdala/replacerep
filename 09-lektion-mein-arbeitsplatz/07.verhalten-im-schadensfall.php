...
<html lang="de">
  <head>
    ...
    <title>Verhalten im Schadensfall :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../09-lektion-mein-arbeitsplatz/07.verhalten-im-schadensfall.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../ansprechpersonen.php" title="Infos / Ansprechpersonen (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../09-lektion-mein-arbeitsplatz/06.messenger.php" title="Messenger-Apps (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Verhalten im Schadensfall</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-laptop"></i></div></div></div>


<h3 id="verdächtige-vorfälle-melden-auf-keinen-fall-gefahren-ignorieren">Verdächtige Vorfälle melden! Auf keinen Fall Gefahren ignorieren!</h3>
<p>Behalten Sie die Ruhe! Sie wissen durch BITS, was Sie zu tun haben!</p>
<p>Sollten Sie den Eindruck haben, dass jemand durch vorsätzliches Einwirken auf Sie versucht, Passwörter, Zugangsdaten oder konkrete Inhaltsdaten zu erkunden, weisen Sie dieses Ansinnen höflich, aber bestimmt zurück und informieren Sie die Ihnen vorgesetzte Person und Ihre <a href="../ansprechpersonen.php">Ansprechperson</a>.</p>
<p>Schalten Sie Ihren Computer beim Verdacht auf einen Virus nicht eigenmächtig aus. Falls Ihnen die Kabel des Rechners vertraut sind, empfiehlt es sich, die Netzwerkverbindung durch Ziehen des entsprechenden Steckers oder Abschalten von WLAN- bzw. Mobilfunkverbindungen zu unterbrechen. Dadurch wird die Verbreitung eines Virus im dienstlichen Netz verhindert.</p>
<p>Tauchen trotz des Befolgens aller hier vorgestellten Regeln Probleme auf, informieren Sie unverzüglich Ihre zuständigen Organisationseinheiten. Die allgemeinen Kontaktdaten finden Sie unter <a href="../ansprechpersonen.php">Infos / Ansprechpersonen</a>.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/09-lektion-mein-arbeitsplatz/07.verhalten-im-schadensfall.php" class="dd-item active"><a href="../09-lektion-mein-arbeitsplatz/07.verhalten-im-schadensfall.php">Verhalten im Schadensfall<i class="fas fa-check read-icon"></i></a></li></ul></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/09-lektion-mein-arbeitsplatz/07.verhalten-im-schadensfall.php" selected>Deutsch</option>
                  </select>
                </div>
