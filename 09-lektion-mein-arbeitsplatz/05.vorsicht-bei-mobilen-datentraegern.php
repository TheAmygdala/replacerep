...
<html lang="de">
  <head>
    ...
    <title>Vorsicht bei mobilen Datenträgern :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../09-lektion-mein-arbeitsplatz/05.vorsicht-bei-mobilen-datentraegern.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../09-lektion-mein-arbeitsplatz/06.messenger.php" title="Messenger-Apps (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../09-lektion-mein-arbeitsplatz/04.social-engineering-angriffe-abwehren.php" title="Social Engineering-Angriffe abwehren (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Vorsicht bei mobilen Datenträgern</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-laptop"></i></div></div></div>


<p>Durch USB-Speichersticks, Smartphones und andere mobile Datenträger können leicht Daten auf und von Computern kopiert werden. Dies birgt erhebliche Gefahren.</p>
<p>Zum einen ist oft nicht nachvollziehbar, welche Daten vom Computer herunterkopiert werden. Somit sind ein „Diebstahl“ und die unberechtigte Verwendung von Daten möglich. Auch lassen sich kleine Geräte leichter verlieren oder stehlen.</p>
<p>Zum anderen besteht die Gefahr, dass auf den mobilen Geräten enthaltene Viren auf Ihren Computer und damit in das dienstliche Netz gelangen.</p>
<p>Verwenden Sie daher mobile Datenträger an Ihrem Arbeitsplatz nur, wenn Ihnen dies gestattet ist und Sie einen aktuellen Virenscanner im Einsatz haben. Fragen Sie im Zweifelsfall Ihre <a href="../ansprechpersonen.php">Ansprechperson</a>.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Mobile Geräte nur verwenden, wenn dies gestattet ist. Im Zweifelsfall nachfragen!</li>
<li>Private Geräte nur bei vorheriger Erlaubnis der IT-Abteilung verwenden!</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/09-lektion-mein-arbeitsplatz/05.vorsicht-bei-mobilen-datentraegern.php" class="dd-item active"><a href="../09-lektion-mein-arbeitsplatz/05.vorsicht-bei-mobilen-datentraegern.php">Vorsicht bei mobilen Datenträgern<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/09-lektion-mein-arbeitsplatz/05.vorsicht-bei-mobilen-datentraegern.php" selected>Deutsch</option>
                  </select>
                </div>
