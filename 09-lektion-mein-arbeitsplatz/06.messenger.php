...
<html lang="de">
  <head>
    ...
    <title>Messenger-Apps :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../09-lektion-mein-arbeitsplatz/06.messenger.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../09-lektion-mein-arbeitsplatz/07.verhalten-im-schadensfall.php" title="Verhalten im Schadensfall (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../09-lektion-mein-arbeitsplatz/05.vorsicht-bei-mobilen-datentraegern.php" title="Vorsicht bei mobilen Datenträgern (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Messenger-Apps</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-laptop"></i></div></div></div>


<h3 id="malware-über-messenger-apps">Malware über Messenger-Apps</h3>
<p>Viele Behörden und Einrichtungen verwenden Messenger-Dienste wie Slack, MS Teams oder Matrix, um den Beschäftigten eine mobile Anwendung für die schnelle Kommunikation bereit zu stellen. Diese Dienste stellen zunächst eine vertrauliche Umgebung für die interne Kommunikation dar.</p>
<p>Aber auch auf diesem Wege können Angreifer*innen Malware einschleusen. Nach einem erfolgreichen Eindringen in das Netzwerk versuchen diese z.B. Benutzerinformationen zu erbeuten, um unter Ihrem Namen schadhafte Links zu verteilen.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Links und Dateianhängen auch in internen Foren oder Arbeitsbereichen nicht ungeprüft vertrauen</li>
<li>Grundsätzlich keine unbekannten oder merkwürdig erscheinenden Links öffnen</li>
<li>Keine Dokumente und Programme auch von bekannten Absender*innen öffnen, sie Ihnen verdächtig oder überraschend erscheinen</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/09-lektion-mein-arbeitsplatz/06.messenger.php" class="dd-item active"><a href="../09-lektion-mein-arbeitsplatz/06.messenger.php">Messenger-Apps<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/09-lektion-mein-arbeitsplatz/06.messenger.php" selected>Deutsch</option>
                  </select>
                </div>
