...
<html lang="de">
  <head>
    ...
    <title>Social Engineering-Angriffe abwehren :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../09-lektion-mein-arbeitsplatz/04.social-engineering-angriffe-abwehren.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../09-lektion-mein-arbeitsplatz/05.vorsicht-bei-mobilen-datentraegern.php" title="Vorsicht bei mobilen Datenträgern (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../09-lektion-mein-arbeitsplatz/03.zugang-sichern.php" title="Zugang sichern (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Social Engineering-Angriffe abwehren</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-laptop"></i></div></div></div>


<p>Seien Sie misstrauisch, wenn jemand Ihre Zugangsdaten, insbesondere Passwörter erfragt. Dies gilt gerade bei Ihnen Unbekannten, die auf Auskunft drängen und sich auf ihre Autorität (hoher Funktionsträger etc.) oder eine hohe Dringlichkeit („Die Zeit drängt…“, „Sie behindern&hellip;“) berufen.</p>
<p>Häufig werden gezielt Personen für Angriffe ausgewählt, die keine sicherheitsrelevanten Aufgaben haben. Über deren Zugänge zu Anwendungen und Netzwerken versuchen die Angreifer und Angreiferinnen als Sprungbrett dann weiter in die Systeme einzudringen.</p>
<p>Wie verhalten Sie sich, wenn Sie Zweifel haben?</p>
<ul>
<li>Lassen Sie sich im Zweifelsfall eine Rückrufnummer geben, die Sie überprüfen.</li>
<li>Erkundigen Sie sich bei Vorgesetzten, Kollegen oder Ihren <a href="../ansprechpersonen.php">Ansprechperson</a>, ob die anfragende Person vertrauenswürdig und „echt“ ist.</li>
</ul>
<p>Weitere Informationen gibt es in der Lektion <a href="../03-lektion-passwoerter/02.gefahren.php#social-engineering">Passwörter</a></p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Geben Sie keine Zugangsdaten heraus</li>
<li>Versichern Sie sich der Identität der abfragenden Person</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/09-lektion-mein-arbeitsplatz/04.social-engineering-angriffe-abwehren.php" class="dd-item active"><a href="../09-lektion-mein-arbeitsplatz/04.social-engineering-angriffe-abwehren.php">Social Engineering-Angriffe abwehren<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/09-lektion-mein-arbeitsplatz/04.social-engineering-angriffe-abwehren.php" selected>Deutsch</option>
                  </select>
                </div>
