...
<html lang="de">
  <head>
    ...
    <title>Zugang sichern :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../09-lektion-mein-arbeitsplatz/03.zugang-sichern.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../09-lektion-mein-arbeitsplatz/04.social-engineering-angriffe-abwehren.php" title="Social Engineering-Angriffe abwehren (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../09-lektion-mein-arbeitsplatz/02.passwoerter-nicht-weitergeben.php" title="Passwörter nicht weitergeben (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Zugang sichern</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-laptop"></i></div></div></div>


<p>Der Computer an Ihrem Arbeitsplatz ist das Tor zu den auf diesem Rechner gespeicherten Daten, aber auch zu Daten auf anderen Computern Ihrer Behörde oder Einrichtung und oft auch zum Internet.</p>
<p>Wenn Sie Ihren Arbeitsplatz verlassen, sollten Sie immer den Zugang zum Computersystem sperren. Dies geschieht mit einem einfachen Handgriff und verhindert, dass Dritte Zugriff auf Daten haben oder in Ihrem Namen Nachrichten schreiben.</p>
<p>Es reicht nicht aus, Ihr Zimmer abzuschließen. Ein geübter Dieb schafft es innerhalb von Sekunden, ein normales Schloss zu öffnen.</p>
<p>Unter Microsoft Windows sperrt z.B. die Tastenkombination „<strong>Windows-Taste + L</strong>“ das System so, dass es nur durch Eingabe Ihres Passwortes oder durch eine Person mit Administratorrechten wieder benutzt werden kann.</p>
<p>Bitte achten Sie auch darauf, dass keine Familienangehörige oder Dritte im Home Office Zugang zum Computer oder Ihren Daten erhalten.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Mit der Tastenkombination „<strong>Windows-Taste + L</strong>“ sichern Sie Ihr System schnell beim Verlassen Ihres Arbeitsplatzes</li>
<li>Das Arbeitszimmer abzuschließen reicht nicht!</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/09-lektion-mein-arbeitsplatz/03.zugang-sichern.php" class="dd-item active"><a href="../09-lektion-mein-arbeitsplatz/03.zugang-sichern.php">Zugang sichern<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/09-lektion-mein-arbeitsplatz/03.zugang-sichern.php" selected>Deutsch</option>
                  </select>
                </div>
