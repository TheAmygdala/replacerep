...
<html lang="de">
  <head>
    ...
    <title>Social Media :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./06-lektion-social-media/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./06-lektion-social-media.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./06-lektion-social-media/01.einleitung.php" title="Social Media-Dienste (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./05-lektion-vertrauliche-daten/90.quiz-vertrauliche-daten.php" title="Quiz - Vertrauliche Daten (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<div class="article-subheading">Lektion 6</div>
<h1>Social Media</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-list"><i class="fas fa-share-square"></i></div></div></div>


<h2 id="sicherer-umgang-mit-soziale-medien">Sicherer Umgang mit Soziale Medien</h2>
<p>In dieser Lektion lernen Sie,</p>
<ul>
<li>was man unter Social Media versteht,</li>
<li>welche Social Media-Dienste es gibt,</li>
<li>welche Probleme bei der Nutzung von Social Media entstehen können und</li>
<li>wie Sie Social Media sicher nutzen können</li>
</ul>
  ...
  <img src="./images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/06-lektion-social-media.php" class="dd-item active parent"><a href="./06-lektion-social-media.php">6. Lektion Social Media<i class="fas fa-check read-icon"></i></a><ul id="subsections-165e1ba5c5785dd7976d9834642ffec7">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/06-lektion-social-media.php" selected>Deutsch</option>
                  </select>
                </div>
