...
<html lang="de">
  <head>
    ...
    <title>Datenschutz :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="./datenschutz.php">
...
<h1>Datenschutz</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-user-shield"></i></div></div></div>


<p><strong>Die Datenschutzerklärung für die Online-Version von BITS finden Sie auf <a href="https://www.bits-training.de/datenschutz">https://www.bits-training.de/datenschutz</a></strong></p>
<p><strong>Diese Seite ist Teil der Demo-Version von BITS. Bitte vor der Nutzung anpassen, dies gilt insbesondere für die Platzhalter [XX]!</strong></p>
<h3 id="datenschutz">Datenschutz</h3>
<p>Verantwortlicher ist [XX], [Anschrift].</p>
<p>Den/die Datenschutzbeauftragte/n erreichen Sie wie folgt: [XX]</p>
<p>Es werden folgende Kategorien personenbezogener Daten verarbeitet: [XX]</p>
<p>Dies erfolgt für die Zwecke: [XX].</p>
<p>Die Rechtsgrundlage hierfür ist Art. 6 Abs. 1 Satz 1 lit.) [XX] Datenschutz-Grundverordnung (DSGVO). [Falls die Rechtsgrundlage lit. f) ist, sind die berechtigten Interessen, z.B. die Bereitstellung der Seiten und deren Sicherheit, zu benennen.]</p>
<p>Empfänger Ihrer Daten ist [XX].</p>
<p>Ihre Daten werden für [XX] Tage gespeichert und dann gelöscht.</p>
<p>Die Verarbeitung der hier genannten Daten ist weder gesetzlich noch vertraglich vorgeschrieben.</p>
<p>Betroffene Personen haben ein Recht auf Auskunft, Berichtigung, Löschung und die Einschränkung der Verarbeitung. Es besteht das Recht auf Beschwerde bei der nach Art. 77 DSGVO zuständigen Aufsichtsbehörde.</p>
<p>Auf das Widerspruchsrecht nach Art. 21 DSGVO wird ausdrücklich hingewiesen.</p>
<h3 id="hosting">Hosting</h3>
<p>Unser Hoster benötigt bestimmte Daten, um die Seiten anzuzeigen und verarbeitet in sog. Logfiles folgende Daten, die Ihr Browser übermittelt:</p>
<p>[XX]</p>
<p>Das ist erforderlich, um unsere Website anzuzeigen und die Stabilität und Sicherheit zu gewährleisten. Dies entspricht unserem berechtigten Interesse im Sinne des Art. 6 Abs. 1 Satz 1 lit. f) DSGVO.</p>
<p>Der Hoster ist Empfänger Ihrer personenbezogenen Daten. Sie werden nach [XX] Tagen gelöscht.</p>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/datenschutz.php" selected>Deutsch</option>
                  </select>
                </div>
