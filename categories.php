...
<html lang="de">
  <head>
    ...
    <title>Categories :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./categories/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./categories.php">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/categories.php" selected>Deutsch</option>
                    <option lang="en" id="en" value="/en/categories.php">English</option>
                  </select>
                </div>
