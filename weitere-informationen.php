...
<html lang="de">
  <head>
    ...
    <title>Weitere Informationen :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="./weitere-informationen.php">
...
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-info"></i></div></div></div>


<ul>
<li>Updates und Infos zu BITS: <a href="https://www.bits-portal.eu/">www.bits-portal.eu</a></li>
<li>Bundesamt für Sicherheit in der Informationstechnik (Bürgerportal): <a href="https://www.bsi-fuer-buerger.de/">www.bsi-fuer-buerger.de</a></li>
<li>Netzdurchblick (Internetratgeber für Jugendliche): <a href="https://www.netzdurchblick.de">https://www.netzdurchblick.de</a></li>
</ul>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/weitere-informationen.php" selected>Deutsch</option>
                  </select>
                </div>
