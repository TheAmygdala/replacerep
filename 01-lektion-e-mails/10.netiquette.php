...
<html lang="de">
  <head>
    ...
    <title>Netiquette :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/10.netiquette.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/11.zusammenfassung.php" title="Zusammenfassung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/09.dienstliche-und-private-nutzung.php" title="Dienstliche und private Nutzung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<p>Noch ein Wort zur „Netiquette“, zum guten Ton beim Informationsaustausch per E-Mail:</p>
<p>Auch bei der elektronischen Post sollte man sich gut ausdrücken und freundlich verhalten. Da Sie mit Ihren E-Mails Ihre Behörde oder Einrichtung auch nach außen vertreten, sollten Sie nicht nur auf den Inhalt, sondern auch die angemessene Anrede und die Darstellung achten.</p>
<p>Hier ein paar <strong>Empfehlungen</strong> für die richtige Netiquette, den höflichen und korrekten Informationsaustausch per E-Mail:</p>
<ul>
<li>Vergessen Sie niemals, dass auf der anderen Seite auch ein Mensch sitzt.</li>
<li>Verwenden Sie eine aussagekräftige Betreff-Zeile („Subject“). Dies erleichtert auch das Finden einer schon abgelegten E-Mail.</li>
<li>Lesen Sie vor dem Absenden Ihren E-Mail-Text auch aus der Perspektive Ihres Gegenübers.</li>
<li>Greifen Sie im Zweifelsfall zum Telefonhörer, um ein Problem zu besprechen.</li>
<li>Überprüfen Sie, ob bestimmte Personen nicht angeschrieben werden müssen.</li>
<li>Verzichten Sie im Zweifelsfall auf emotionale oder humoristische Andeutungen. Diese können zu Missverständnissen führen.</li>
<li>Verzichten Sie auf Spaß-Anhänge oder Bilder.</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/10.netiquette.php" class="dd-item active"><a href="../01-lektion-e-mails/10.netiquette.php">Netiquette<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/10.netiquette.php" selected>Deutsch</option>
                  </select>
                </div>
