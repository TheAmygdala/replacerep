...
<html lang="de">
  <head>
    ...
    <title>Vertrauliche Informationen :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/08.vertrauliche-informationen.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/09.dienstliche-und-private-nutzung.php" title="Dienstliche und private Nutzung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/07.erste-hilfe.php" title="Erste Hilfe (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Vertrauliche Informationen</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-envelope-open-text"></i></div></div></div>


<p>Wir alle arbeiten heute mit mehr oder weniger vertraulichen Informationen. Gerade bei der Verwendung von E-Mails kann es leicht passieren, dass sensible Daten an die falschen oder an zu viele Empfänger oder Empfängerinnen geschickt werden.</p>
<p>Der unverschlüsselte Versand vertraulicher Informationen über das Internet kommt dem Versand sensibler Daten per Postkarte gleich und ist daher zu unterlassen.</p>
<p>Den Inhalt und Anhänge von E-Mails kann man verschlüsseln, so dass Texte, Fotos etc. nicht ohne weiteres lesbar sind. Möglich machen das mathematische Verschlüsselungsverfahren. Sie verändern die Inhalte so, dass nur Berechtigte sie lesen können. Die berechtigten Empfänger*innen der E-Mail können sie nach dem Entschlüsseln öffnen. Die „Postkarte“ E-Mail ist so auch für die Übermittlungsstellen nicht zu lesen.</p>
<p>Falls Sie unsicher sind, ob Ihre Einrichtung eine Verschlüsselungsmöglichkeit für E-Mails anbietet, kontaktieren Sie Ihre <a href="../ansprechpersonen.php">Ansprechperson</a>.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p><strong>So verhalten Sie sich richtig im <em>internen</em> Netz</strong></p>
<p>Wichtig ist es, vor dem Versand einer E-Mail</p>
<ul>
<li>die Empfängerliste daraufhin zu überprüfen, ob eventuell unerwünschte Personen enthalten sind (insbesondere bei Antworten auf eine E-Mail und dem Klicken auf „Allen antworten“), und</li>
<li>zu überprüfen, ob die ausgewählten Anlagen, Empfängernamen bzw. E-Mail-Adressen korrekt sind.</li>
</ul>
<p><strong>So verhalten Sie sich richtig im <em>Internet</em></strong></p>
<p>Beachten Sie beim Versand einer E-Mail über das Internet:</p>
<ul>
<li>vertrauliche Daten sollten nur in Ausnahmefällen an externe Personen per E-Mail geschickt werden,</li>
<li>vertrauliche Daten dürfen nicht unverschlüsselt über unsichere Wege verschickt werden - dazu gehört gerade das Internet!</li>
<li>Sollten Sie keine E-Mail-Verschlüsselung durchführen können, müssen vertrauliche Daten über die üblichen alternativen, meist papiergebundenen Wege (also einen Brief oder Aktenversand) übermittelt werden. Ein Fax arbeitet heute technisch (unsicher) wie eine E-Mail!</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails.php" class="dd-item parent"><a href="../01-lektion-e-mails.php">1. Lektion E-Mails<i class="fas fa-check read-icon"></i></a><ul id="subsections-c086ac896b3ee5509d006b237df7eb0d">
          ...
          <li data-nav-id="/01-lektion-e-mails/08.vertrauliche-informationen.php" class="dd-item active"><a href="../01-lektion-e-mails/08.vertrauliche-informationen.php">Vertrauliche Informationen<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/08.vertrauliche-informationen.php" selected>Deutsch</option>
                  </select>
                </div>
