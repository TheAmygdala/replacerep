...
<html lang="de">
  <head>
    ...
    <title>Computerviren per E-Mail :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/04.computerviren.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/05.phishing-und-pharming.php" title="Phishing und Pharming (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/03.spam-e-mails.php" title="Spam-E-Mails (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Computerviren per E-Mail</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-envelope-open-text"></i></div></div></div>


<p>Computerviren stellen eine große Bedrohung für Computer und die dort gespeicherten Daten dar. Computerviren sind kleine Programmteile, die sich unbemerkt an ein anderes Programm anhängen und so auf fremden Rechnern ausgeführt werden können. Häufig kommen sie als E-Mail-Anhang auf Ihren Computer.</p>
<p>Von hier aus verbreiten sie sich weiter, verändern oder spionieren Daten aus oder führen andere zerstörerische Aktionen auf Ihrem Rechner oder in Ihrem Netzwerk durch.</p>
<h2 id="schutz-vor-computerviren">Schutz vor Computerviren</h2>
<p>In einer Behörde oder Einrichtung wird eine E-Mail normalerweise an zwei Stellen auf Viren untersucht („gescannt“): zentral beim Empfang der E-Mail aus dem Internet und zusätzlich auf Ihrem Computer, wenn Sie die E-Mail öffnen. Achten Sie darauf, ob Ihr Virenscanner aktiviert oder ein Fehler anzeigt ist - auch zuhause!</p>
<h4 id="weshalb-sie-trotzdem-vorsichtig-sein-sollten">Weshalb Sie trotzdem vorsichtig sein sollten:</h4>
<ul>
<li>Es gibt kein Schutzprogramm, das alle Viren beseitigen kann</li>
<li>Es sind Situationen denkbar, in denen der Virenscanner nicht arbeiten kann, z.B. wenn eine E-Mail verschlüsselt ist</li>
<li>Allein das Betrachten einer E-Mail kann einen Virus aktivieren</li>
</ul>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p><strong>Daher sollten Sie:</strong></p>
<ul>
<li>E-Mail-Inhalten und Dateianhängen nicht ungeprüft vertrauen,</li>
<li>grundsätzlich keine unbekannten oder merkwürdig erscheinenden E-Mails öffnen,</li>
<li>keine Dokumente und Programme von unbekannten Absendern öffnen, ohne sich zuvor über deren Vertrauenswürdigkeit zu vergewissern.</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/04.computerviren.php" class="dd-item active"><a href="../01-lektion-e-mails/04.computerviren.php">Computerviren per E-Mail<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/04.computerviren.php" selected>Deutsch</option>
                  </select>
                </div>
