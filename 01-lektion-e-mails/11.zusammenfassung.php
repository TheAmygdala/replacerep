...
<html lang="de">
  <head>
    ...
    <title>Zusammenfassung :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/11.zusammenfassung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/90.quiz-e-mails.php" title="Quiz - E-Mails (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/10.netiquette.php" title="Netiquette (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h3 id="hier-noch-einmal-die-wichtigsten-regeln">Hier noch einmal die wichtigsten Regeln:</h3>
<ul>
<li>Vertrauen Sie niemals leichtgläubig E-Mail-Inhalten, der Absenderadresse und Dateianhängen.</li>
<li>Öffnen Sie keine Dokumente und Programme Ihnen unbekannter Personen.</li>
<li>Informieren Sie bei Verdacht auf Virenbefall Ihre <a href="../ansprechpersonen.php">Ansprechperson</a>.</li>
<li>Geben Sie fehlgeleitete Informationen nicht weiter, sondern informieren Sie die absendende Person und löschen Sie die E-Mail.</li>
<li>Falls Sie selber eine vertrauliche E-Mail falsch versendet haben: Bitten Sie um Löschung und informieren Sie Ihre vorgesetzte Person.</li>
<li>Wenn Sie eine Phishing-Mail bekommen: nicht antworten, keinen Link anklicken, keine sensiblen Daten weitergeben, keine Anhänge öffnen.</li>
<li>Senden Sie vertrauliche Daten über das Internet nur verschlüsselt.</li>
<li>Achten Sie auf die <a href="../01-lektion-e-mails/10.netiquette.php">&ldquo;Netiquette“</a>.</li>
<li>Bitte informieren Sie sich über die genauen Regelungen bzgl. der E-Mail-Nutzung in Ihrer Behörde oder Einrichtung.</li>
</ul>
...
<p>Es ist im Allgemeinen nicht üblich, Nachrichten zu überwachen. Jedoch kann es für die Sicherheit der IT-Systeme notwendig sein, die Nutzung der elektronischen Kommunikationssysteme - also den Zu- und Abgang von E-Mails - zu beobachten, z.B. um Viren zu erkennen.</p>
<p>Aus diesem Grund werden in vielen Behörden und Einrichtungen automatisch Protokolle zu den sog. Verkehrsdaten (Uhrzeit, Beteiligte etc.) erstellt. Das Mitlesen der Inhalte ist grundsätzlich verboten.</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/11.zusammenfassung.php" class="dd-item active"><a href="../01-lektion-e-mails/11.zusammenfassung.php">Zusammenfassung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/11.zusammenfassung.php" selected>Deutsch</option>
                  </select>
                </div>
