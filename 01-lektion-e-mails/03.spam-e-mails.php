...
<html lang="de">
  <head>
    ...
    <title>Spam-E-Mails :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/03.spam-e-mails.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/04.computerviren.php" title="Computerviren per E-Mail (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/02.uebermittlung-von-e-mails.php" title="Übermittlung von E-Mails im Internet (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<p>E-Mails kosten kein Porto. Das führt zu einem unschönen Problem:</p>
<p>Es ist einfach, tausende von E-Mails zu verschicken. Das wird von Firmen für den Versand von Werbe-Mails ausgenutzt, die kostbare Ressourcen belegen und Ihr Postfach füllen. Diese Werbe-Mails werden auch als Spam-E-Mails, kurz „Spam“ oder Junk-Mails bezeichnet.</p>
<p>Ca. 60% der heute empfangenen E-Mails sind Spam. In vielen Behörden und Einrichtungen werden E-Mails beim Eingang automatisch zentral überprüft. Offensichtliche Spam-E-Mails werden dann entsprechend gekennzeichnet oder automatisch gelöscht.</p>
...
<ul>
<li>Beantworten Sie keine Spam-E-Mails</li>
<li>Öffnen Sie keine Anhänge von unbekannten Absendern</li>
<li>Laden Sie bei unerwünschten Mails keine Bilder nach, da Sie dadurch die Erreichbarkeit Ihrer E-Mail-Adresse bestätigen</li>
<li>Löschen Sie Spam-E-Mails aus Ihrem Postfach</li>
<li>Vermeiden Sie bei unbekannten E-Mails das Klicken auf Links innerhalb des Texts - diese können gefälscht sein</li>
<li>Um zu erkennen, wohin der Link in einer E-Mail tatsächlich führt, fahren Sie mit dem Mauszeiger über den Link-Text - Ihr Browser zeigt meist unten im E-Mail-Programm oder in einem Ballon-Fenster das tatsächliche Ziel. Diese Funktion gibt es bei Smartphones normalerweise nicht!</li>
<li>Geben Sie im Zweifelsfall Links lieber per Hand in die Adresszeile Ihres Browsers ein</li>
</ul>
    </div>
</div>
...
<div class="box notices cstyle tip">
    ...
    <div class="box-content">
<p>Manchmal enthalten Spam-E-Mails auch Angriffstechniken wie Phishing, Viren oder Würmer. Mehr dazu sogleich und in der Lektion <a href="../02-lektion-viren.php">Viren</a>.</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/03.spam-e-mails.php" class="dd-item active"><a href="../01-lektion-e-mails/03.spam-e-mails.php">Spam-E-Mails<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/03.spam-e-mails.php" selected>Deutsch</option>
                  </select>
                </div>
