...
<html lang="de">
  <head>
    ...
    <title>Dienstliche und private Nutzung :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/09.dienstliche-und-private-nutzung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/10.netiquette.php" title="Netiquette (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/08.vertrauliche-informationen.php" title="Vertrauliche Informationen (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Dienstliche und private Nutzung</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-envelope-open-text"></i></div></div></div>


<p>In vielen Behörden und Einrichtungen  ist die Nutzung der dienstlichen E-Mail-Adresse zum Versand privater E-Mails nicht erlaubt. Dieses Verbot ist rechtlich zulässig und muss von Ihnen beachtet werden. Genaueres regeln Dienstvereinbarungen oder anderen interne Vorgaben.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p><strong>Ist in Ihrer Behörde oder Einrichtung die private Nutzung der dienstlichen E-Mail-Adresse erlaubt?</strong></p>
<ul>
<li>Wenn nein - verzichten Sie darauf!</li>
<li>Wenn ja - nutzen Sie diese nur im angemessenen Umfang und versenden und empfangen Sie allenfalls kleine Dateien!</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/09.dienstliche-und-private-nutzung.php" class="dd-item active"><a href="../01-lektion-e-mails/09.dienstliche-und-private-nutzung.php">Dienstliche und private Nutzung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/09.dienstliche-und-private-nutzung.php" selected>Deutsch</option>
                  </select>
                </div>
