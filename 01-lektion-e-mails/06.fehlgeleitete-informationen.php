...
<html lang="de">
  <head>
    ...
    <title>Fehlgeleitete Informationen :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/06.fehlgeleitete-informationen.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/07.erste-hilfe.php" title="Erste Hilfe (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/05.phishing-und-pharming.php" title="Phishing und Pharming (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Fehlgeleitete Informationen</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-envelope-open-text"></i></div></div></div>


<p>Immer wieder führt menschliches Fehlverhalten dazu, dass Informationen fehlgeleitet werden und so in falsche Hände geraten. Dies kann unter Umständen erhebliche wirtschaftliche und rechtliche Folgen für Sie, Ihre Kolleginnen und Kollegen und Ihre Behörde oder Einrichtung haben.</p>
<p>Falls Sie versehentlich eine E-Mail bekommen, die nicht für Sie bestimmt ist,</p>
<ul>
<li>geben Sie die E-Mail und deren Inhalt nicht weiter,</li>
<li>informieren Sie den Absender oder die Absenderin,</li>
<li>löschen Sie die E-Mail aus Ihrem Postfach.</li>
</ul>
<p>Hinweise in einer E-Mail, die Regelungen für den Fall eines Fehlversands enthalten, sind rechtlich nicht bindend.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/06.fehlgeleitete-informationen.php" class="dd-item active"><a href="../01-lektion-e-mails/06.fehlgeleitete-informationen.php">Fehlgeleitete Informationen<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/06.fehlgeleitete-informationen.php" selected>Deutsch</option>
                  </select>
                </div>
