...
<html lang="de">
  <head>
    ...
    <title>Übermittlung von E-Mails im Internet :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/02.uebermittlung-von-e-mails.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/03.spam-e-mails.php" title="Spam-E-Mails (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/01.was-sind-emails.php" title="Was sind E-Mails? (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Übermittlung von E-Mails im Internet</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-envelope-open-text"></i></div></div></div>


<p>Ähnlich wie bei der Briefpost werden E-Mails im Internet von einem „Briefzentrum“ zum nächsten „Briefzentrum“ in Form von Computerservern geschickt und schließlich den Adressat*innen zugestellt. Im Unterschied zur Briefpost gibt es jedoch beim E-Mail-Transport über das Internet keinen allein verantwortlichen Dienstleister, der die Beförderung und Zustellung übernimmt. Die E-Mail wird auf nicht vorhersagbaren Wegen über viele Rechner in unterschiedlichsten Firmen, Behörden und Ländern weitergeleitet. Außerdem wird die Identität der absendenden Person nicht überprüft.</p>
<p>Überhaupt ist eine E-Mail am ehesten mit einer Postkarte vergleichbar, die von allen möglichen Personen auf ihrem Weg gelesen und sogar verändert werden kann. Es könnte also z.B. passieren, dass Sie eine E-Mail mit einer gefälschten Absenderadresse oder veränderten Inhalten bekommen!</p>
<p>Auf den folgenden Seiten werden die unterschiedlichen Gefahren bei der E-Mail-Nutzung erläutert.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/02.uebermittlung-von-e-mails.php" class="dd-item active"><a href="../01-lektion-e-mails/02.uebermittlung-von-e-mails.php">Übermittlung von E-Mails im Internet<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/02.uebermittlung-von-e-mails.php" selected>Deutsch</option>
                  </select>
                </div>
