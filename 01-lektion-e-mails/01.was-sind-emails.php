...
<html lang="de">
  <head>
    ...
    <title>Was sind E-Mails? :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/01.was-sind-emails.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/02.uebermittlung-von-e-mails.php" title="Übermittlung von E-Mails im Internet (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails.php" title="E-Mails (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Was sind E-Mails?</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-envelope-open-text"></i></div></div></div>


<p>E-Mails sind elektronische Nachrichten, die innerhalb einer Behörde oder Einrichtung, aber auch weltweit über das Internet mit dem Computer, Smartphone, Laptop etc. versendet und empfangen werden. Auch wenn im privaten Bereich mittlerweile elektronische Nachrichten häufiger über Messenger-Programme wie Signal, WhatsApp oder Telegram per Smartphone versendet werden, haben E-Mails im Beruf weiter eine große praktische Bedeutung.</p>
<p>Dabei besteht eine E-Mail im Allgemeinen aus einer oder mehreren Empfänger-Adressen, einem Betreff („Subject“), einer Absender-Adresse, dem E-Mail-Text („Body“) und eventuell Anlagen („Attachments“).</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Wissen Sie, von wem eine E-Mail wirklich stammt?</li>
<li>Wurde die E-Mail wirklich in dieser Form verschickt? Oder wurde sie unterwegs verändert?</li>
<li>Kann ein angefügtes Dokument gefahrlos geöffnet werden?</li>
</ul>
    </div>
</div>
...
<div class="box notices cstyle tip">
    ...
    <div class="box-content">
<p>E-Mail = Electronic Mail (Elektronische Post)</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/01.was-sind-emails.php" class="dd-item active"><a href="../01-lektion-e-mails/01.was-sind-emails.php">Was sind E-Mails?<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/01.was-sind-emails.php" selected>Deutsch</option>
                  </select>
                </div>
