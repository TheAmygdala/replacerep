...
<html lang="de">
  <head>
    ...
    <title>Quiz - E-Mails :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/90.quiz-e-mails.php">
...
3. [ ] Schädliche Programme, die jedoch in Ihrer Behörde oder Einrichtung keine Gefahr darstellen, weil sie durch Verschlüsselungssoftware und Virenscanner sofort unschädlich gemacht werden.
...
2. [x] Vertrauliche Daten dürfen nur verschlüsselt über das Internet verschickt werden.
	...
	> **Richtige Antwort!**
3. [ ] Die Daten müssen an den „Vertraulichkeitsbeauftragten“ Ihrer Behörde oder Einrichtung geschickt werden, der sie dann verschlüsselt über das Internet weiterleitet.
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/01-lektion-e-mails/90.quiz-e-mails.php" class="dd-item active"><a href="../01-lektion-e-mails/90.quiz-e-mails.php">Quiz - E-Mails<i class="fas fa-check read-icon"></i></a></li></ul></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/90.quiz-e-mails.php" selected>Deutsch</option>
                  </select>
                </div>
