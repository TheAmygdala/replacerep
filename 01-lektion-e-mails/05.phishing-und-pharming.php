...
<html lang="de">
  <head>
    ...
    <title>Phishing und Pharming :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/05.phishing-und-pharming.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/06.fehlgeleitete-informationen.php" title="Fehlgeleitete Informationen (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/04.computerviren.php" title="Computerviren per E-Mail (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Phishing und Pharming</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-envelope-open-text"></i></div></div></div>


<p>Typische Computerangriffe werden über Phishing und Pharming vorbereitet.</p>
<p><strong>Phishing</strong> meint den Passwortdiebstahl per Internet. Er erfolgt meist per E-Mail. Phishing-E-Mails sind als seriöse Nachricht z. B. einer Bank getarnt und fordern den Empfänger oder die Empfängerin auf, persönliche Daten, Passwörter oder PINs zu aktualisieren. Mit den dann auf einer gefälschten Website eingegebenen Daten können die Betrügerinnen und Betrüger ungehindert die Konten plündern. Dies ist eine der häufigsten Spielarten der Online-Kriminalität. Jeder einzelne Vorstoß kann mehrere Millionen Internetnutzerinnen und -nutzer erreichen.</p>
<p>Beim <strong>Spear-Phishing</strong> wird das Opfer gezielt ausgewählt. Das können auch Sie sein! Alle Hierarchie-Ebenen von der Sachbearbeitung und Assistenz bis zur Leitungsebene stehen im Fokus.</p>
<p>Beim <strong>Pharming</strong> besteht der Angriff darin, eine in den Browser eingegebene Internetadresse unbemerkt auf eine andere Seite umzulenken. Obwohl Sie die korrekte Internetadresse eingetippt haben, erfolgt beim Aufruf der Webseite eine automatische Umleitung auf die Seite des Angreifers! Dort lauern dann Viren oder man will Ihre Kontozugangsdaten unberechtigt abfragen.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p><strong>So verhalten Sie sich richtig:</strong></p>
<ul>
<li>Geben Sie niemals geheime Daten wie Passwörter, Kontodaten, PIN oder TAN nach Aufruf eines Links aus einer E-Mail ein.</li>
<li>Passwörter, PIN und TAN sollten Sie nur auf den Original-Servern des Kreditinstituts eingeben - am Besten immer die Internet-Adresse eintippen oder Lesezeichen nutzen!</li>
<li>Achten Sie bei der Adresse auf die richtige Schreibweise.</li>
<li>Achtung: Bankangestellte fragen Sie niemals nach Ihrem Passwort oder fordern Sie per E-Mail zur Aktualisierung Ihrer persönlichen Daten auf!</li>
<li>Überprüfen Sie gegebenenfalls die Gültigkeit des Web-Server-Zertifikats</li>
</ul>
<p>Wie Sie für eine Web-Adresse die Gültigkeit des Web-Server-Zertifikats überprüfen können, erfahren Sie in der Lektion <a href="../04-lektion-internet.php">Internet</a>.</p>
    </div>
</div>
...
<div class="box notices cstyle tip">
    ...
    <div class="box-content">
<p><strong>Phishing</strong> = Passwortdiebstahl per E-Mail</p>
<p><strong>Pharming</strong> = Umlenkung einer häufig genutzten Internetseite auf eine böswillig veränderte</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/01-lektion-e-mails/05.phishing-und-pharming.php" class="dd-item active"><a href="../01-lektion-e-mails/05.phishing-und-pharming.php">Phishing und Pharming<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/05.phishing-und-pharming.php" selected>Deutsch</option>
                  </select>
                </div>
