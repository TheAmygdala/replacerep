...
<html lang="de">
  <head>
    ...
    <title>Erste Hilfe :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../01-lektion-e-mails/07.erste-hilfe.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../01-lektion-e-mails/08.vertrauliche-informationen.php" title="Vertrauliche Informationen (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../01-lektion-e-mails/06.fehlgeleitete-informationen.php" title="Fehlgeleitete Informationen (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h2 id="was-tun-wenn-man-selbst-einen-fehler-gemacht-hat">Was tun, wenn man <strong>selbst</strong> einen Fehler gemacht hat?</h2>
<p>Wenn Sie eine E-Mail versehentlich an eine falsche Person gesendet haben, bewahren Sie Ruhe und gehen Sie wie folgt vor:</p>
<ul>
<li>Informieren Sie den Empfänger oder die Empfängerin über die fälschlich übermittelte E-Mail und bitten Sie um deren Löschung</li>
<li>Informieren Sie unverzüglich Ihre vorgesetzte Person</li>
<li>Leiten Sie gemeinsam mit Ihren Vorgesetzten und ggf. dem / der Datenschutzbeauftragten Ihrer Behörde oder Einrichtung alle notwendigen Maßnahmen zur Begrenzung des Schadens ein</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/01-lektion-e-mails/07.erste-hilfe.php" class="dd-item active"><a href="../01-lektion-e-mails/07.erste-hilfe.php">Erste Hilfe<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails/07.erste-hilfe.php" selected>Deutsch</option>
                  </select>
                </div>
