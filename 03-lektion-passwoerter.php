...
<html lang="de">
  <head>
    ...
    <link href="./03-lektion-passwoerter/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./03-lektion-passwoerter.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./03-lektion-passwoerter/01.erklaerung.php" title="Erklärung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./02-lektion-viren/90.quiz-viren.php" title="Quiz - Viren (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
  ...
  <img src="./images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/03-lektion-passwoerter.php" class="dd-item active parent"><a href="./03-lektion-passwoerter.php">3. Lektion Passwörter<i class="fas fa-check read-icon"></i></a><ul id="subsections-ca409e2b4cb5e26079deffb2f40f407a">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/03-lektion-passwoerter.php" selected>Deutsch</option>
                  </select>
                </div>
