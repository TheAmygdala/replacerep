...
<html lang="de">
  ...
  <body class="mobile-support default" data-url="../03-lektion-passwoerter/05.zusammenfassung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../03-lektion-passwoerter/90.quiz-passwoerter.php" title="Quiz - Passwörter (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../03-lektion-passwoerter/04.werkzeuge-fuer-passwoerter.php" title="Werkzeuge für Passwörter (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h3 id="wir-fassen-die-wichtigsten-passwort-regeln-zusammen">Wir fassen die wichtigsten Passwort-Regeln zusammen:</h3>
<ul>
<li>Sichere, möglichst für jede Anwendung einmalige Passwörter verwenden</li>
<li>Mindestens acht Zeichen lang, Buchstaben und Zahlen sowie Groß- und Kleinschreibung verwenden</li>
<li>Keine Passwörter aus Wörterbüchern, keine Namen, Geburtsdaten etc.</li>
<li>Notieren Sie Ihr Passwort nirgendwo</li>
<li>Falls verfügbar, nutzen Sie Passwort-Manager und die Zwei-Faktoren-Authentifzierung (2FA)</li>
<li>Geben Sie Ihr Passwort nicht an andere Personen weiter</li>
<li>Wenn Sie keine besonders langen Passwörter verwenden, ändern Sie diese regelmäßig</li>
<li>Seien Sie wachsam bei Anfragen nach Zugangsdaten oder Passwörtern - versucht jemand einen Social Engineering-Angriff?</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/03-lektion-passwoerter/05.zusammenfassung.php" class="dd-item active"><a href="../03-lektion-passwoerter/05.zusammenfassung.php">Zusammenfassung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/03-lektion-passwoerter/05.zusammenfassung.php" selected>Deutsch</option>
                  </select>
                </div>
