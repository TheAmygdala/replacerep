...
<html lang="de">
  <head>
    ...
    <title>Der richtige Umgang :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../03-lektion-passwoerter/03.der-richtige-umgang.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../03-lektion-passwoerter/04.werkzeuge-fuer-passwoerter.php" title="Werkzeuge für Passwörter (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../03-lektion-passwoerter/02.gefahren.php" title="Gefahren (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Der richtige Umgang</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-lock-open"></i></div></div></div>


<h3 id="passwörter-bilden-und-merken">Passwörter bilden und merken</h3>
<p>Sie können ein Sprichwort, eine Liedzeile oder einen Begriff in Kombination mit Ziffern und Sonderzeichen verwenden, um daraus ein Passwort zu erstellen. Aus  „Siebenmeilenstiefel“ wird zum Beispiel durch die Ersetzung des Wortes Sieben durch die Zahl „7“, Meilen durch die Abkürzung „km“ und die Ersetzung des Buchstabens „i“ durch ein Ausrufezeichen das sichere Passwort <em>7kmSt!efel</em>.</p>
<p>Ein <strong>Trick</strong>, um mehrere sichere Passwörter für verschiedene Anwendungen oder Internetseiten zu besitzen: Bilden Sie wie hier geschildert ein Passwort und stellen Sie diesem bei jeder Anwendung oder Internetseite ein individuelles Kürzel voran, zum Beispiel so:</p>
<ul>
<li>Grundpasswort: Ich habe fünf Finger an der Hand = Ih5F@dH</li>
<li>Variante für <strong>PC</strong>-Anmeldung: <strong>PC</strong>Ih5F@dH</li>
<li>Variante für das <strong>M</strong>elde<strong>r</strong>egisterverfahren: <strong>MR</strong>Ih5F@dH</li>
</ul>
<h3 id="richtiger-umgang-mit-passwörtern">Richtiger Umgang mit Passwörtern</h3>
<ul>
<li>
<p>Wenn Ihr Passwort auf einem Zettel am Monitor klebt, können alle, die in Ihr Büro kommen, dieses lesen. Würden Sie die PIN Ihrer Bank-Karte öffentlich aushängen oder Ihren Haustürschlüssel zum Nachmachen auslegen?!?</p>
</li>
<li>
<p>Aus dem gleichen Grund gilt: <strong>Passwörter dürfen nirgends notiert werden!</strong></p>
</li>
<li>
<p>Achten Sie bei der Eingabe darauf, dass Sie niemand beobachtet. Es ist nicht unhöflich, Anwesende darum zu bitten wegzusehen!</p>
</li>
</ul>
<h3 id="weitergabe-von-passwörtern">Weitergabe von Passwörtern</h3>
<p><strong>Passwörter dürfen nie weitergegeben werden.</strong> Sie sind geheim und personengebunden. Alle Berechtigten haben ein eigenes Passwort. Sie benötigen nicht das Ihrige! So schützen Sie sich auch selbst vor Verdächtigungen, falls es Unregelmäßigkeiten bei der Verwendung Ihrer Kennung gibt.</p>
<p>Auch Hacker*innen wollen Ihr Passwort, z.B. telefonisch unter Vorspiegelung falscher Tatsachen, erfragen.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<ul>
<li>Geben Sie Ihr Passwort niemals weiter, auch nicht an Kolleginnen oder Kollegen</li>
<li>Nutzen Sie sichere Passwörter, auch im privaten Bereich</li>
<li>Schreiben Sie Passwörter nicht auf</li>
<li>Passwortkarten und Passwortmanager können hilfreich sein</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/03-lektion-passwoerter/03.der-richtige-umgang.php" class="dd-item active"><a href="../03-lektion-passwoerter/03.der-richtige-umgang.php">Der richtige Umgang<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/03-lektion-passwoerter/03.der-richtige-umgang.php" selected>Deutsch</option>
                  </select>
                </div>
