...
<html lang="de">
  <head>
    ...
    <title>Erklärung :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../03-lektion-passwoerter/01.erklaerung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../03-lektion-passwoerter/02.gefahren.php" title="Gefahren (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../03-lektion-passwoerter.php" title="Passwörter (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h3 id="warum-passwörter">Warum Passwörter?</h3>
<p>Passwörter dienen der Zugangskontrolle. Sie sichern sensible und schützenswerte Daten, Systeme und Programme.</p>
<p>Sie können ein Passwort mit Ihrem Haustürschlüssel vergleichen. Mit diesem kontrollieren Sie den Zugang zu Ihrem Haus. Genauso kontrolliert man mit dem Schlüssel „Passwort“ den Zugang zu sensiblen Daten und Verfahren.</p>
<h3 id="wo-werden-passwörter-verwendet">Wo werden Passwörter verwendet?</h3>
<p>Passwörter werden bei Anmeldungen an Rechnern, Netzwerken oder Netzlaufwerken verwendet. Sie schützen Ressourcen wie Dateien und Informationen vor unberechtigtem Lesen, Schreiben, Ändern oder Löschen.</p>
<p>Auch der Zugang zu einzelnen Programmen wird häufig durch Passwörter geschützt. Zum Beispiel können nur Sie mit Ihrem Anmeldenamen und Ihrem Passwort Ihre E-Mails lesen.</p>
<h3 id="wie-sieht-ein-sicheres-passwort-aus">Wie sieht ein sicheres Passwort aus?</h3>
<p>Der Name Ihres Lebenspartners oder Ihrer Lebenspartnerin, Ihr Autokennzeichen, Ihr Geburtsdatum oder Ihre Telefonnummer stellen <strong>keine</strong> guten Passwörter dar. Sie könnten leicht erraten oder abgeleitet werden. Auch Fremdwörter oder Wörter einer anderen Sprache sind keine gute Wahl, da diese mit automatisierten Verfahren über Wörterbuch- oder Brute-Force-Angriffe durch Erraten geknackt werden können.</p>
<p>Ein sicheres Passwort ist mindestens acht Zeichen lang und besteht aus einer Kombination von großen und kleinen Buchstaben, Zahlen und Sonderzeichen wie z.B. Ausrufezeichen oder Fragezeichen. Außerdem sollten keine Buchstaben genutzt werden, die auf der Tastatur direkt nebeneinander liegen. Idealerweise sollte das Passwort einmalig sein.</p>
<p>In den meisten Behörden und Einrichtungen müssen Passwörter regelmäßig geändert werden, wobei die zuletzt gewählten Passwörter nicht wiederverwendet werden dürfen.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/03-lektion-passwoerter/01.erklaerung.php" class="dd-item active"><a href="../03-lektion-passwoerter/01.erklaerung.php">Erklärung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/03-lektion-passwoerter/01.erklaerung.php" selected>Deutsch</option>
                  </select>
                </div>
