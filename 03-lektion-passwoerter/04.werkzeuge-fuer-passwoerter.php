...
<html lang="de">
  <head>
    ...
    <title>Werkzeuge für Passwörter :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../03-lektion-passwoerter/04.werkzeuge-fuer-passwoerter.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../03-lektion-passwoerter/05.zusammenfassung.php" title="Zusammenfassung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../03-lektion-passwoerter/03.der-richtige-umgang.php" title="Der richtige Umgang (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Werkzeuge für Passwörter</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-lock-open"></i></div></div></div>


<p>Es gibt Werkzeuge für Passwörter, die Ihnen das Erzeugen und Merken erleichtern oder die Sicherheit erheblich erhöhen. Falls Ihre Behörde oder Einrichtung solche anbietet: nutzen Sie diese! Auch für den privaten Bereich gibt es solche Tools!</p>
<h3 id="passwort-manager">Passwort-Manager</h3>
<p>Passwort-Manager sind Computer-Anwendungen, die es häufig auch als Apps für Smartphones gibt, und die zum Erzeugen und Speichern von sicheren Passwörtern dienen. Voraussetzung ist, dass Sie ein sehr sicheres „Master-Passwort“ verwenden, das den Zugang zum Passwort-Manager selbst freigibt. Außerdem muss das Programm die in ihm gespeicherten weiteren Passwörter gut verschlüsseln.</p>
<p>Der Vorteil eines Passwort-Managers ist, dass Sie sich nur das Master-Passwort merken müssen. Dies ist gleichzeitig der größte Nachteil. Wenn Sie es vergessen, haben Sie keinen Zugang zu den weiteren Passwörtern!</p>
<h3 id="zwei-faktor-authentisierung-2fa">Zwei-Faktor-Authentisierung (2FA)</h3>
<p>Bei einer Zwei-Faktor-Authentisierung (abgekürzt 2FA) wird neben dem Wissen (z.B. ein nur Ihnen bekanntes Passwort) noch ein weiteres Merkmal beim Einloggen in ein Programm oder zum Abrufen von Nachrichten verlangt. Dies kann ein Stück Hardware in Form eines kleinen Sticks („Token“) sein, der auf einem Display eine einmalige Nummer auf Knopfdruck anzeigt. Es gibt aber auch Smartphone-Apps, die bei 2FA genutzt werden können. Über die App oder den Token müssen Sie dann beim Einloggen diesen Vorgang zusätzlich bestätigen. Diese Form der 2FA kommt regelmäßig beim Online-Banking oder beim Online-Kauf vor.</p>
<h3 id="passwortkarten">Passwortkarten</h3>
<p>Passwortkarten sind unveränderliche Tabellen mit Buchstaben, Zahlen und Sonderzeichen. Durch eine gedachtes Master-Passwort können diese verknüpft und zu neuen Passwörten zusammengesetzt werden.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p>Nutzen Sie Passwort-Manager und die Zwei-Faktor-Authentisierung, wenn Ihnen diese von Ihrem Arbeitgeber angeboten werden. Beide erhöhen die Sicherheit!</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/03-lektion-passwoerter/04.werkzeuge-fuer-passwoerter.php" class="dd-item active"><a href="../03-lektion-passwoerter/04.werkzeuge-fuer-passwoerter.php">Werkzeuge für Passwörter<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/03-lektion-passwoerter/04.werkzeuge-fuer-passwoerter.php" selected>Deutsch</option>
                  </select>
                </div>
