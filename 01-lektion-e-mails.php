...
<html lang="de">
  <head>
    ...
    <title>E-Mails :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./01-lektion-e-mails/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./01-lektion-e-mails.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./01-lektion-e-mails/01.was-sind-emails.php" title="Was sind E-Mails? (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./einleitung.php" title="Einleitung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<div class="article-subheading">Lektion 1</div>
<h1>E-Mails</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-list"><i class="fas fa-envelope"></i></div></div></div>


<h2 id="sicherer-umgang-mit-elektronischer-post">Sicherer Umgang mit elektronischer Post</h2>
<p>In dieser Lektion lernen Sie,</p>
<ul>
<li>warum ein falscher Umgang mit E-Mails eine Gefahr für Sie und Ihre Behörde oder Einrichtung darstellt,</li>
...
<li>wie man E-Mails angemessen schreibt - „Netiquette“</li>
</ul>
  ...
  <img src="./images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/01-lektion-e-mails.php" class="dd-item active parent"><a href="./01-lektion-e-mails.php">1. Lektion E-Mails<i class="fas fa-check read-icon"></i></a><ul id="subsections-c086ac896b3ee5509d006b237df7eb0d">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/01-lektion-e-mails.php" selected>Deutsch</option>
                  </select>
                </div>
