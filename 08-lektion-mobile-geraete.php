...
<html lang="de">
  <head>
    ...
    <title>Mobile Geräte :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./08-lektion-mobile-geraete/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./08-lektion-mobile-geraete.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./08-lektion-mobile-geraete/01.einleitung.php" title="Einleitung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./07-lektion-cloud/90.quiz-cloud.php" title="Quiz - Cloud (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<div class="article-subheading">Lektion 8</div>
<h1>Mobile Geräte</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-list"><i class="fas fa-mobile"></i></div></div></div>


<h2 id="sicherheitshinweise-für-mobile-geräte">Sicherheitshinweise für mobile Geräte</h2>
<p>In dieser Lektion lernen Sie,</p>
<ul>
<li>welche Geräte unter dem Begriff „mobile Geräte“ zusammengefasst werden,</li>
<li>welchen besonderen Gefahren und Risiken mobile Geräte ausgesetzt sind,</li>
<li>welche Gefahren drahtlose Kommunikationsnetze mit sich bringen und</li>
<li>welche Sicherheitsregeln im Zusammenhang mit mobilen Geräten und WLAN beachtet werden sollten</li>
</ul>
  ...
  <img src="./images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/08-lektion-mobile-geraete.php" class="dd-item active parent"><a href="./08-lektion-mobile-geraete.php">8. Lektion Mobile Geräte<i class="fas fa-check read-icon"></i></a><ul id="subsections-6e49a72e993d6de5173dd8cf540c0e8f">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/08-lektion-mobile-geraete.php" selected>Deutsch</option>
                  </select>
                </div>
