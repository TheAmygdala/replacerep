...
<html lang="de">
  <head>
    ...
    <link href="./05-lektion-vertrauliche-daten/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./05-lektion-vertrauliche-daten.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./05-lektion-vertrauliche-daten/01.vertrauliche-daten.php" title="Vertrauliche Daten (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./04-lektion-internet/90.quiz-internet.php" title="Quiz - Internet (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<div class="article-subheading">Lektion 5</div>
<h1>Vertrauliche Daten</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-list"><i class="fas fa-check-double"></i></div></div></div>


<h2 id="daten-die-einen-besonderen-schutz-benötigen">Daten, die einen besonderen Schutz benötigen</h2>
<p>In dieser Lektion lernen Sie,</p>
<ul>
<li>wie wichtig es für Sie und Ihre Behörde oder Einrichtung ist, dass alle mit vertraulichen Daten richtig umzugehen wissen,</li>
<li>wie Sie feststellen können, welche Daten als schützenswert gelten,</li>
<li>wie Sie sicher mit vertraulichen Daten umgehen,</li>
<li>wer Sie bei Fragen und Problemen zum Thema Vertraulichkeit unterstützen kann.</li>
</ul>
  ...
  <img src="./images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten.php" class="dd-item active parent"><a href="./05-lektion-vertrauliche-daten.php">5. Lektion Vertrauliche Daten<i class="fas fa-check read-icon"></i></a><ul id="subsections-8574f37cb9b73a543c3e0995f6d96b4a">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten.php" selected>Deutsch</option>
                  </select>
                </div>
