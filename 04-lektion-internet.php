...
<html lang="de">
  <head>
    ...
    <title>Surfen im Internet :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./04-lektion-internet/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./04-lektion-internet.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./04-lektion-internet/01.was-ist-das-internet.php" title="Was ist das Internet? (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./03-lektion-passwoerter/90.quiz-passwoerter.php" title="Quiz - Passwörter (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<div class="article-subheading">Lektion 4</div>
<h1>Surfen im Internet</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-list"><i class="fas fa-globe-europe"></i></div></div></div>


<h2 id="sicherheit-im-weltweiten-datennetz">Sicherheit im weltweiten Datennetz</h2>
<p>In dieser Lektion lernen Sie,</p>
<ul>
<li>was der Zugang zum Internet bedeutet,</li>
<li>welche Gefahren im Internet lauern und wie Sie diese erkennen,</li>
<li>wie Sie sicher im Internet surfen können und</li>
<li>welche allgemeinen Regeln Sie bei der Internetnutzung beachten sollten.</li>
</ul>
  ...
  <img src="./images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/04-lektion-internet.php" class="dd-item active parent"><a href="./04-lektion-internet.php">4. Lektion Surfen im Internet<i class="fas fa-check read-icon"></i></a><ul id="subsections-911c81fe2e5d5f812c0fca36c69f8bdf">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/04-lektion-internet.php" selected>Deutsch</option>
                  </select>
                </div>
