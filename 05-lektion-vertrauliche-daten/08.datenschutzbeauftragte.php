...
<html lang="de">
  <head>
    ...
    <title>Datenschutzbeauftragte :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/08.datenschutzbeauftragte.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../05-lektion-vertrauliche-daten/09.zusammenfassung.php" title="Zusammenfassung (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/07.persoenlich-vertrauliche-informationen.php" title="Persönlich-vertrauliche Informationen (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<p>Jede <strong>Behörde</strong> in der Europäischen Union ist nach dem Datenschutzrecht (Art. 37 EU-Datenschutz-Grundverordnung) verpflichtet, eine Person als Datenschutzbeauftragte*r zu benennen. Sie wacht über die Einhaltung der Datenschutzgesetze bei der Verarbeitung personenbezogener Daten. Sie ist zu besonderer Verschwiegenheit verpflichtet.</p>
<p>In <strong>Unternehmen</strong> muss ein Datenschutzbeauftragter bzw. eine Datenschutzbeauftragte bestellt werden, soweit dort in der Regel mindestens 20 Personen ständig mit der automatisierten Verarbeitung personenbezogener Daten beschäftigt sind (§ 38 Bundesdatenschutzgesetz).</p>
<p>Der / die Datenschutzbeauftragte Ihrer Behörde oder Einrichtung kann Ihnen bei konkreten Fragen zum Datenschutz weiterhelfen. Die entsprechenden Kontaktdaten finden Sie <a href="../ansprechpersonen.php">hier</a>. Dort finden Sie auch die zuständige Person für die Informationssicherheit.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/08.datenschutzbeauftragte.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/08.datenschutzbeauftragte.php">Datenschutzbeauftragte<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/08.datenschutzbeauftragte.php" selected>Deutsch</option>
                  </select>
                </div>
