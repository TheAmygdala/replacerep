...
<html lang="de">
  <head>
    ...
    <title>Quiz - Vertrauliche Daten :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/90.quiz-vertrauliche-daten.php">
    <div id="body" class="default-animation">
      ...
      <nav id="topbar" class="highlightable">
        <div>
             ...
             <a class="nav nav-next" href="../06-lektion-social-media.php" title="Social Media (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
             </div> 
             EOT;
             echo filterSingleNodeHref($html);
             ?>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/09.zusammenfassung.php" title="Zusammenfassung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
1. [ ] Arbeitsvertrag
	...
	>Leider falsch! In den meisten Behörden und Einrichtungen ist es üblich, mit dem Arbeitsvertrag eine Datenschutzerklärung zu unterschreiben, die den verantwortlichen Umgang mit vertraulichen Informationen regelt.
2. [x] Datenschutzerklärungen

	>**Richtige Antwort**
3. [ ] Informationssicherheitsleitlinie

	>Nein. In den meisten Behörden und Einrichtungen ist es üblich, mit dem Arbeitsvertrag eine Datenschutzerklärung zu unterschreiben, die den verantwortlichen Umgang mit vertraulichen Informationen regelt. Die Informationssicherheitsleitlinie beschreibt den Rahmen für das Informationssicherheitsmanagement.
  ...
  <img src="../images/logo.jpg" width="220" height="80" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/90.quiz-vertrauliche-daten.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/90.quiz-vertrauliche-daten.php">Quiz - Vertrauliche Daten<i class="fas fa-check read-icon"></i></a></li></ul></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/90.quiz-vertrauliche-daten.php" selected>Deutsch</option>
                  </select>
                </div>
