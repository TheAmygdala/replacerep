...
<html lang="de">
  <head>
    ...
    <title>Identifizierung vertraulicher Daten :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/03.identifizierung-vertraulicher-daten.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../05-lektion-vertrauliche-daten/04.betriebsgeheimnisse.php" title="Betriebsgeheimnisse (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/02.elektronische-datenverarbeitung.php" title="Elektronische Datenverarbeitung (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Identifizierung vertraulicher Daten</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-check"></i></div></div></div>


<h2 id="schlüsselfrage-zur-bewertung">Schlüsselfrage zur Bewertung:</h2>
<h3 id="sind-die-daten-durch-gesetzliche-oder-behördliche-bestimmungen-geschützt"><em>Sind die Daten durch gesetzliche oder behördliche Bestimmungen geschützt?</em></h3>
<p>Ihre Behörde oder Einrichtung unterliegt stets dem jeweils für sie gültigen Datenschutzgesetz. In einigen Ländern und beim Bund gibt es zudem Informationsfreiheitsgesetze, in denen u.a. ein Anspruch für jedermann auf Offenlegung der bei einer Behörde vorliegenden Daten geregelt ist. Ausgenommen sind regelmäßig personenbezogene Daten und Betriebs- oder Geschäftsgeheimnisse. Hierdurch wird das Datenschutzrecht in den Bereich des Informationsfreiheitsrechts einbezogen.</p>
<p>Aber auch interne Regelungen, z.B. Verschlusssachenanweisungen, sind zu beachten!</p>
<h3 id="vertraulich-intern-geheim">Vertraulich? Intern? Geheim?</h3>
<p>Zunächst gilt es, die Regelungen des Datenschutzrechts und ggf. des Informationsfreiheitsrechts zu beachten.</p>
<p>Schutzbedürftig sind alle <strong>personenbezogenen Daten</strong>. Darunter versteht man „alle Informationen, die sich auf eine identifizierte oder identifizierbare natürliche Person beziehen“ (Art. 4 Nr. 1 EU-Datenschutz-Grundverordnung). Hierzu zählen neben Name, Geburtsdatum und Anschrift auch Gesundheitsdaten und persönliche Vorlieben.</p>
<p>Darüber hinaus ist es üblich, Informationen in <strong>Vertraulichkeitsklassen</strong> einzustufen. Die Zuordnung zu einer bestimmten Klasse kann dann zu bestimmten Verhaltensregeln führen. Sollte es keine internen Regelungen in Ihrer Behörde oder Einrichtung zum Datenschutz geben, können die Beispiele auf den nächsten Seiten zur Orientierung dienen.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/03.identifizierung-vertraulicher-daten.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/03.identifizierung-vertraulicher-daten.php">Identifizierung vertraulicher Daten<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/03.identifizierung-vertraulicher-daten.php" selected>Deutsch</option>
                  </select>
                </div>
