...
<html lang="de">
  <head>
    ...
    <title>Entscheidungsrelevante Informationen :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/06.entscheidungsrelevante-informationen.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../05-lektion-vertrauliche-daten/07.persoenlich-vertrauliche-informationen.php" title="Persönlich-vertrauliche Informationen (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/05.interne-informationen.php" title="Interne Informationen (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Entscheidungsrelevante Informationen</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-check"></i></div></div></div>


<p>Es gibt weitere interne Informationen, die insbesondere der Vorbereitung von Entscheidungen dienen oder diese dokumentieren.</p>
<p><strong>Beispiele:</strong></p>
<p>Bilanzen, Angebotsunterlagen, nichtöffentliche Verwaltungsunterlagen für Gremien, Protokolle des Verwaltungsvorstandes, aus Verwaltungsrat- und Aufsichtsratssitzungen, Informationen über die Struktur der internen IT-Anlagen</p>
<p><strong>Verhaltensregeln:</strong></p>
<ul>
<li>Für wen? Solche Informationen sollten nur dem Teil der Beschäftigten zur Verfügung gestellt werden, der diese für seine Tätigkeit benötigt.</li>
<li>Bei Außenstehenden? Bei Weitergabe an Dritte ist neben den Bedingungen, die für interne Informationen gelten, auch die Zustimmung der Leitungsebene erforderlich oder es gibt allgemeine interne Regelungen.</li>
<li>Wie transportieren? Es ist ein sicherer Transportweg zu wählen. Das heißt z.B. beim Versand über das Internet ist eine hinreichende Verschlüsselung zwingend notwendig.</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/06.entscheidungsrelevante-informationen.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/06.entscheidungsrelevante-informationen.php">Entscheidungsrelevante Informationen<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/06.entscheidungsrelevante-informationen.php" selected>Deutsch</option>
                  </select>
                </div>
