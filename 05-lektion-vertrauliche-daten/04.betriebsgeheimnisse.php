...
<html lang="de">
  <head>
    ...
    <title>Betriebsgeheimnisse :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/04.betriebsgeheimnisse.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../05-lektion-vertrauliche-daten/05.interne-informationen.php" title="Interne Informationen (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/03.identifizierung-vertraulicher-daten.php" title="Identifizierung vertraulicher Daten (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Betriebsgeheimnisse</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-check"></i></div></div></div>


<p><strong>Betriebs- und Geschäftsgeheimnisse</strong> sind geschützt - selbst wenn ein Informationsfreiheitsgesetz Auskunftsansprüche gegenüber einer Behörde schafft.</p>
<p>Nach den geltenden Informationsfreiheits- bzw. Transparenzgesetzen ist ein Antrag auf Informationszugang zu einer Verwaltung abzulehnen, soweit durch die Übermittlung der Information ein Betriebs- oder Geschäftsgeheimnis offenbart wird und dadurch ein wirtschaftlicher Schaden entstehen würde.</p>
<p>Anders als zum Beispiel <strong>Informationen, die allgemein zugänglich sind</strong> und durch deren Verlust kein Schaden oder kein Verstoß gegen Auflagen (z.B. Prospekte, Broschüren, Webseite) entsteht, gibt es Daten und Informationen, deren Weitergabe Einschränkungen unterliegt.</p>
<p>Die folgenden Seiten beschreiben Beispiele.</p>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/04.betriebsgeheimnisse.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/04.betriebsgeheimnisse.php">Betriebsgeheimnisse<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/04.betriebsgeheimnisse.php" selected>Deutsch</option>
                  </select>
                </div>
