...
<html lang="de">
  <head>
    ...
    <title>Persönlich-vertrauliche Informationen :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/07.persoenlich-vertrauliche-informationen.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../05-lektion-vertrauliche-daten/08.datenschutzbeauftragte.php" title="Datenschutzbeauftragte (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/06.entscheidungsrelevante-informationen.php" title="Entscheidungsrelevante Informationen (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Persönlich-vertrauliche Informationen</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-check"></i></div></div></div>


<p>Persönlich-vertrauliche Informationen sind vor allem personenbezogene Daten nach dem Datenschutzrecht.</p>
<p><strong>Beispiele:</strong></p>
<p>Personalakten, Daten der Gehaltsabrechnung, personenbezogene Daten von Kund*innen (z.B. Anschrift, Geburtsdatum, beantragte Leistung).</p>
<p><strong>Verhaltensregeln:</strong></p>
<ul>
<li>Unter bestimmten Voraussetzungen darf es aufgrund einer gesetzlichen Erlaubnis, eines Vertrages oder einer Einwilligung der betroffenen Person zu einer Datenübermittlung kommen.</li>
<li>Prüfen Sie die Anforderungen genau! Ein einmal übermitteltes elektronisches Datum kann nicht zurückgeholt werden!</li>
<li>Persönlich-vertrauliche Informationen sind für andere unzugänglich aufzubewahren.</li>
<li>Die Informationsfreiheits- und Transparenzgesetze, die für die betroffenen Behörden gelten, schützen ausdrücklich personenbezogene Daten, auch wenn ein grundsätzlicher Auskunftsanspruch besteht.</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/07.persoenlich-vertrauliche-informationen.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/07.persoenlich-vertrauliche-informationen.php">Persönlich-vertrauliche Informationen<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/07.persoenlich-vertrauliche-informationen.php" selected>Deutsch</option>
                  </select>
                </div>
