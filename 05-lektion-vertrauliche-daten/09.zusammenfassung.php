...
<html lang="de">
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/09.zusammenfassung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../05-lektion-vertrauliche-daten/90.quiz-vertrauliche-daten.php" title="Quiz - Vertrauliche Daten (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/08.datenschutzbeauftragte.php" title="Datenschutzbeauftragte (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h3 id="hier-noch-einmal-die-wichtigsten-regeln-zur-vertraulichkeit-von-daten">Hier noch einmal die wichtigsten Regeln zur Vertraulichkeit von Daten:</h3>
<ul>
<li>Gesetzliche und ethische Gründe erfordern einen aktiven Daten- und Informationsschutz - von allen!</li>
<li>Beachten Sie die Regelungen und Vorschriften des Datenschutz- und Informationsfreiheitsrechts und interne Regelungen</li>
<li>Vor der Weiterleitung von Informationen sind enthaltene Meta-Informationen, die Schutzwürdigkeit und die Empfängerliste zu prüfen</li>
<li>Besondere Vorsicht gilt bei der Verarbeitung personenbezogener Daten</li>
<li>Für Verschlusssachen (z.B. „VS-NfD“) gelten Spezialregelungen!</li>
<li>Im Zweifel mit der Leitungsebene abstimmen!</li>
</ul>
<p>Etwaige interne Richtlinien sind nicht auf elektronisch gespeicherte Informationen beschränkt. Sie gelten genauso für den Umgang mit Papierdokumenten und sonstigen Akten.</p>

<div class="box notices cstyle tip">
    <div class="box-label"><i class="fa-fw fas fa-lightbulb"></i> Gut zu wissen</div>
    <div class="box-content">
<p><strong>Datenschutzerklärung</strong></p>
<p>In den meisten Fällen muss man beim Eintritt in den Dienst eine Datenschutzerklärung unterschreiben. Sie ist die Grundlage für die hier vorgestellten Verhaltensregeln. Schützen Sie Ihre Kundinnen und Kunden, Ihre Einrichtung und Ihre Kollegenschaft durch den verantwortlichen Umgang mit vertraulichen Informationen. Die Leitung Ihrer Behörde oder Einrichtung verlässt sich auf Sie!</p>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <div id="content-wrapper" class="highlightable">
        <ul class="topics">
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/09.zusammenfassung.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/09.zusammenfassung.php">Zusammenfassung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/09.zusammenfassung.php" selected>Deutsch</option>
                  </select>
                </div>
