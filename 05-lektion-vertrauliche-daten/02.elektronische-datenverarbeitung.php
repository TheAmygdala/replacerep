...
<html lang="de">
  <head>
    ...
    <title>Elektronische Datenverarbeitung :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/02.elektronische-datenverarbeitung.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../05-lektion-vertrauliche-daten/03.identifizierung-vertraulicher-daten.php" title="Identifizierung vertraulicher Daten (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/01.vertrauliche-daten.php" title="Vertrauliche Daten (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Elektronische Datenverarbeitung</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-check"></i></div></div></div>


<h2 id="heading"></h2>
<p>Mit der zunehmenden Digitalisierung von Daten sind wichtige und kritische Informationen auch elektronisch verfügbar. Dadurch können sie schneller verarbeitet, aber auch unkontrolliert weitergeleitet und kopiert werden.</p>
<p>Dabei kann heute fast jede interne Information zum Nachteil Ihrer Behörde oder Einrichtung oder der Kund*innen ausgenutzt werden. Wie alle wichtigen Daten müssen deshalb auch digitale Informationen vor unberechtigtem Zugriff geschützt werden. Das Datenschutzrecht und die Informationssicherheit verpflichten uns, angemessene technische und organisatorische Schutzmaßnahmen zu treffen.</p>
<h2 id="weiterleitung-von-informationen">Weiterleitung von Informationen</h2>
<h4 id="erst-prüfen-dann-versenden">Erst prüfen, dann versenden!</h4>
<p>Bevor Sie sensible Daten weitergeben, sollten Sie kurz drei Punkte prüfen:</p>
<ul>
<li><em>Besteht eine Rechtsgrundlage zur Weitergabe personenbezogener Daten?</em>
Zur Weitergabe personenbezogener Daten ist eine Rechtsgrundlage (Vertrag oder Gesetz) oder die Einwilligung der betroffenen Person erforderlich.</li>
<li><em>Kann ich der empfangenden Stelle vertrauen? Darf sie die enthaltenen Informationen sehen?</em>
Stellen Sie sicher, dass Sie die richtigen Adressat*innen verwenden. Weisen Sie gegebenenfalls darauf hin, dass die Daten vertraulich sind oder nicht weitergegeben werden dürfen.</li>
<li><em>Wohin gelangen die Informationen?</em>
Insbesondere beim unverschlüsselten Versand über das Internet sollten Sie sicher sein, dass die Daten nicht vertraulich sind. Aber auch beim Senden an Drucker, die nicht an Ihrem Arbeitsplatz stehen, müssen Sie sicherstellen, dass keine Einsichtnahme durch Unbefugte möglich ist.</li>
</ul>
<p>Bei unverschlüsseltem E-Mail-Verkehr dürfen Sie nie vertrauliche Daten versenden. E-Mails und Faxe sind wie Postkarten lesbar! Versenden Sie im Zweifelsfall Briefe.</p>
<p>Achten Sie bei Office-Dokumenten wie z.B. Word-Dateien oder Excel-Tabellen darauf, die sogenannten Meta-Informationen in den Eigenschaften zu löschen, die für die Empfänger*innen nicht erforderlich sind.</p>

<div class="box notices cstyle note">
    <div class="box-label"><i class="fa-fw fas fa-exclamation-circle"></i> Achtung</div>
    <div class="box-content">
<p><strong>Meta-Informationen löschen</strong></p>
<p>Meta-Informationen in Dokumenten über Autor*innen etc.  finden Sie z.B. in MS Office-Anwendungen bei geöffneter Datei unter „Datei - Information (oder Eigenschaften) - Alle Eigenschaften anzeigen“. Sie können die Inhalte der einzelnen Felder dort löschen.</p>
    </div>
</div>
...
<li>Geben Sie auch Ihre persönlichen Daten nur im erforderlichen Umfang weiter.</li>
</ul>
    </div>
</div>
  ...
  <img src="../images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten.php" class="dd-item parent"><a href="../05-lektion-vertrauliche-daten.php">5. Lektion Vertrauliche Daten<i class="fas fa-check read-icon"></i></a><ul id="subsections-8574f37cb9b73a543c3e0995f6d96b4a">
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/02.elektronische-datenverarbeitung.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/02.elektronische-datenverarbeitung.php">Elektronische Datenverarbeitung<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/02.elektronische-datenverarbeitung.php" selected>Deutsch</option>
                  </select>
                </div>
