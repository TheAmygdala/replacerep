...
<html lang="de">
  <head>
    ...
    <title>Interne Informationen :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="../05-lektion-vertrauliche-daten/05.interne-informationen.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="../05-lektion-vertrauliche-daten/06.entscheidungsrelevante-informationen.php" title="Entscheidungsrelevante Informationen (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="../05-lektion-vertrauliche-daten/04.betriebsgeheimnisse.php" title="Betriebsgeheimnisse (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<h1>Interne Informationen</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-check"></i></div></div></div>


<p>Unternehmens- und behördeninterne Daten sind grundsätzlich zu schützen!</p>
<p><strong>Beispiele:</strong></p>
<p>Telefonlisten, Informationen über interne Arbeitsabläufe</p>
<p><strong>Verhaltensregeln:</strong></p>
<ul>
<li>Interne Informationen sind normalerweise nur für die Beschäftigen der Behörde oder Einrichtung zugänglich. Sie dürfen nur mit Zustimmung der Leitungsebene nach außen gegeben werden.</li>
<li>Vor der Weitergabe interner Informationen ist zu prüfen, ob gegebenenfalls eine Datenschutz- oder Vertraulichkeitserklärung abzuschließen ist.</li>
</ul>
  ...
  <img src="../images/logo.jpg" width="220" height="140" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/05-lektion-vertrauliche-daten/05.interne-informationen.php" class="dd-item active"><a href="../05-lektion-vertrauliche-daten/05.interne-informationen.php">Interne Informationen<i class="fas fa-check read-icon"></i></a></li>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/05-lektion-vertrauliche-daten/05.interne-informationen.php" selected>Deutsch</option>
                  </select>
                </div>
