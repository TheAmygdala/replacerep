...
<html lang="en">
  <head>
    ...
    <title>Tags :: BITS | IT security training for public authorities</title>
    <link href="../en/tags/index.xml" rel="alternate" type="application/rss+xml" title="BITS | IT security training for public authorities">
  ...
  <body class="mobile-support html" data-url="../en/tags.php">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/tags.php">Deutsch</option>
                    <option lang="en" id="en" value="/en/tags.php" selected>English</option>
                  </select>
                </div>
