...
<html lang="en">
  <head>
    ...
    <title>BITS | IT security training for public authorities</title>
    <link href="../en/index.xml" rel="alternate" type="application/rss+xml" title="BITS | IT security training for public authorities">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          ...
          <div id="breadcrumbs">
            ...
            <span class="links">
              BITS | IT security training for public authorities
            </span>
          </div>
        </div>
      </nav>
...
<li>create an <em>index.php</em> file in the <!-- raw HTML omitted -->static<!-- raw HTML omitted --> folder and fill the file with HTML content</li>
</ul>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/">Deutsch</option>
                    <option lang="en" id="en" value="/en/" selected>English</option>
                  </select>
                </div>
