...
<html lang="de">
  <head>
    ...
    <title>Impressum :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support default" data-url="./impressum.php">
...
<h1>Impressum</h1>
</div><div id="site-icon-post"><div id="site-icon" class="site-icon-page"><i class="fas fa-file-contract"></i></div></div></div>


<p><strong>Das Impressum für die Online-Version von BITS finden Sie auf <a href="https://www.bits-training.de/impressum">https://www.bits-training.de/impressum</a></strong></p>
...
<h3 id="informationen-zum-diensteanbieter-gemäß--5-absatz-1-telemediengesetz">Informationen zum Diensteanbieter gemäß § 5 Absatz 1 Telemediengesetz</h3>
<table>
<thead>
<tr>
<th>Impressum</th>
<th>[Hier eintragen]</th>
<th>[Hilfsspalte]</th>
</tr>
</thead>
<tbody>
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/impressum.php" selected>Deutsch</option>
                  </select>
                </div>
