...
<html lang="de">
  <head>
    ...
    <title>Mein Arbeitsplatz :: BITS | Behörden-IT-Sicherheitstraining</title>
    <link href="./09-lektion-mein-arbeitsplatz/index.xml" rel="alternate" type="application/rss+xml" title="BITS | Behörden-IT-Sicherheitstraining">
  ...
  <body class="mobile-support html" data-url="./09-lektion-mein-arbeitsplatz.php">
      ...
      <nav id="topbar" class="highlightable">
        <div>
          <div class="navigation">
             <a class="nav nav-next" href="./09-lektion-mein-arbeitsplatz/01.sicherer-arbeitsplatz.php" title="Sicherer Arbeitsplatz (&#129106;)"><i class="fas fa-chevron-right fa-fw"></i></a>
          </div>
          <div class="navigation">
             <a class="nav nav-prev" href="./08-lektion-mobile-geraete/90.quiz-mobile-geraete.php" title="Quiz - Mobile Geräte (&#129104;)"><i class="fas fa-chevron-left fa-fw"></i></a>
          </div>
          <div id="breadcrumbs">
...
<div class="article-subheading">Lektion 9</div>
<h1>Mein Arbeitsplatz</h1>


<h2 id="ihr-einfluss-auf-die-it-sicherheit">Ihr Einfluss auf die IT-Sicherheit</h2>
<p>Diese Lektion fasst zusammen,</p>
<ul>
<li>welche Gefahren an Ihrem Arbeitsplatz (im Büro, unterwegs oder im Home Office) hinsichtlich der IT-Sicherheit bestehen,</li>
<li>welche Maßnahmen Sie an Ihrem Arbeitsplatz für die Sicherheit Ihrer Daten treffen können,</li>
<li>wie Sie sich in einem Schadensfall verhalten sollten.</li>
</ul>
...
<ul>
<li>Ein Großteil der Gefahren entsteht durch Unachtsamkeit der Nutzer und Nutzerinnen.</li>
<li>Arbeiten Sie daher umsichtig und sorgfältig!</li>
<li>Seien Sie sich Ihrer Verantwortung für Ihren Arbeitsplatz bewusst!</li>
<li>Wenden Sie sich Zweifelsfall an Ihre <a href="./ansprechpersonen.php">Ansprechperson</a>!</li>
</ul>
    </div>
</div>
  ...
  <img src="./images/logo.jpg" width="220" height="70" alt="BITS Logo" title="BITS | Behörden-IT-Sicherheitstraining">
      ...
      <?php
        ...
        $htmlString = <<<EOT
          ...
          <li data-nav-id="/09-lektion-mein-arbeitsplatz.php" class="dd-item active parent"><a href="./09-lektion-mein-arbeitsplatz.php">9. Lektion Mein Arbeitsplatz<i class="fas fa-check read-icon"></i></a><ul id="subsections-6db172a1665b7651aa25232915030c8a">
              ...
              <div class="padding select-container">
                ...
                <div class="select-style">
                  ...
                  <select id="select-language" onchange="location = baseUri + this.value;">
                    <option lang="de" id="de" value="/09-lektion-mein-arbeitsplatz.php" selected>Deutsch</option>
                  </select>
                </div>
