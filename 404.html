...
<html lang="de">
  <head>
    ...
    <title>404 Page not found :: BITS | Behörden-IT-Sicherheitstraining</title>
  ...
  <body class="mobile-support" data-url="./">
    <div id="body" class="default-animation" style="margin-left:0px;">
      ...
      <main id="body-inner" class="chapter body-404" tabindex="-1">
        ...
        <div class="flex-block-wrapper">
          ...
          <p></p>
          <p>Huch. Diese Seite scheint nicht zu existieren ¯\_(ツ)_/¯.</p>
          <p></p>
          <p><a href="./">Gehe zur Homepage</a></p>
        </div>
      </main>
    </div>
  </body>
